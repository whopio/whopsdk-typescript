...
describe('resource cards', () => {
  ...
  // Mock server tests are disabled
  test.skip('secrets', async () => {
    const responsePromise = client.cards.secrets('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('pin', async () => {
    const responsePromise = client.cards.pin('id');
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('updatePin: only required params', async () => {
    const responsePromise = client.cards.updatePin('id', { pin: 'pin' });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  // Mock server tests are disabled
  test.skip('updatePin: required and optional params', async () => {
    const response = await client.cards.updatePin('id', { pin: 'pin' });
  });
});
