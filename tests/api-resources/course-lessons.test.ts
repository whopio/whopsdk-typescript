...
describe('resource courseLessons', () => {
  ...
  test.skip('create: only required params', async () => {
    const responsePromise = client.courseLessons.create({ chapter_id: 'chap_xxxxxxxxxxxxx', lesson_type: 'text' });
  ...
  test.skip('update: request options and params are passed correctly', async () => {
    ...
    await expect(client.courseLessons.update('lesn_xxxxxxxxxxxxx', {
  ...
  test.skip('list: request options and params are passed correctly', async () => {
    // ensure the request options are being passed correctly by passing an invalid HTTP method in order to cause an error
    await expect(client.courseLessons.list({
    after: 'after',
    before: 'before',
    chapter_id: 'chap_xxxxxxxxxxxxx',
  ...
  test.skip('submitAssessment: only required params', async () => {
    const responsePromise = client.courseLessons.submitAssessment('lesson_id', { answers: [{ question_id: 'question_id' }] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('submitAssessment: required and optional params', async () => {
    const response = await client.courseLessons.submitAssessment('lesson_id', { answers: [{
