...
describe("PayoutAccountsClient", () => {
    test("retrieve (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/payout_accounts/poact_xxxxxxxxxxxx")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.payoutAccounts.retrieve({
            id: "poact_xxxxxxxxxxxx",
        });
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.payoutAccounts.retrieve({
                id: "id",
            });
