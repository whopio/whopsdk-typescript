...
describe("AuthorizedUsersClient", () => {
    test("list (1)", async () => {
    ...
    test("list (2)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(400).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.authorizedUsers.list();
    ...
    test("list (3)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(401).jsonBody(rawResponseBody).build();
    ...
    test("list (4)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(403).jsonBody(rawResponseBody).build();
    ...
    test("list (5)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(404).jsonBody(rawResponseBody).build();
    ...
    test("list (6)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(422).jsonBody(rawResponseBody).build();
    ...
    test("list (7)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(429).jsonBody(rawResponseBody).build();
    ...
    test("list (8)", async () => {
        ...
        server.mockEndpoint().get("/authorized_users").respondWith().statusCode(500).jsonBody(rawResponseBody).build();
    ...
    test("retrieve (1)", async () => {
        ...
        server
            .mockEndpoint()
            .get("/authorized_users/ausr_xxxxxxxxxxxxx")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();

        const response = await client.authorizedUsers.retrieve({
            id: "ausr_xxxxxxxxxxxxx",
        });
        expect(response).toEqual(rawResponseBody);
    });
    ...
    test("retrieve (2)", async () => {
        ...
        await expect(async () => {
            return await client.authorizedUsers.retrieve({
                id: "id",
            });
        }).rejects.toThrow(Whop.BadRequestError);
    });
    ...
    test("delete (1)", async () => {
        ...
        server
            .mockEndpoint()
            .delete("/authorized_users/ausr_xxxxxxxxxxxxx")
            .respondWith()
            .statusCode(200)
            .jsonBody(rawResponseBody)
            .build();
    ...
    test("delete (2)", async () => {
        ...
        await expect(async () => {
            return await client.authorizedUsers.delete({
                id: "id",
            });
        }).rejects.toThrow(Whop.BadRequestError);
    });
