...
export namespace PaymentAuthorizedWebhookEvent {
  ...
  export interface Data {
     ...
     */
    disputes: Array<Data.Dispute> | null;
     ...
     */
    financing_transactions: Array<Data.FinancingTransaction>;
     ...
     * permission.
     */
    resolutions: Array<Data.Resolution> | null;
     ...
     */
    verification_checks: Data.VerificationChecks | null;
...
export interface PaymentCreatedWebhookEvent {
   ...
   * status, currency, and payment method used.
   */
  data: PaymentCreatedWebhookEvent.Data;
...
export namespace PaymentCreatedWebhookEvent {
  /**
   * A payment represents a completed or attempted charge. Payments track the amount,
   * status, currency, and payment method used.
   */
...
export interface PaymentPendingWebhookEvent {
   ...
   * status, currency, and payment method used.
   */
  data: PaymentPendingWebhookEvent.Data;
...
export namespace PaymentPendingWebhookEvent {
  /**
   * A payment represents a completed or attempted charge. Payments track the amount,
   * status, currency, and payment method used.
   */
