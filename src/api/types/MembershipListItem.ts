...
export interface MembershipListItem {
    ...
    company: MembershipListItem.Company;
    ...
    member: MembershipListItem.Member | null;
    ...
    user: MembershipListItem.User | null;
}

export namespace MembershipListItem {
    /**
     * The company this membership belongs to.
     */
