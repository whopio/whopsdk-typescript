...
export interface PaymentLegacy {
    ...
    application_fee: PaymentLegacy.ApplicationFee | null;
    /** Whether this payment was auto refunded or not */
    auto_refunded: boolean;
    /** The address of the user who made the payment. */
    billing_address: PaymentLegacy.BillingAddress | null;
    ...
    company: PaymentLegacy.Company | null;
    ...
    disputes: PaymentLegacy.Disputes.Item[] | null;
    /** If the payment failed, the reason for the failure. */
    failure_message: string | null;
    /** The fees associated with this specific payment. */
    fees: PaymentLegacy.Fees.Item[];
    ...
    financing_transactions: PaymentLegacy.FinancingTransactions.Item[];
    /** The unique identifier for the payment. */
    id: string;
    /** The time of the last payment attempt. */
    last_payment_attempt: string | null;
    /** The member attached to this payment. */
    member: PaymentLegacy.Member | null;
    /** The membership attached to this payment. */
    membership: PaymentLegacy.Membership | null;
    ...
    payment_instrument: PaymentLegacy.PaymentInstrument | null;
    /** The tokenized payment method reference used for this payment. Null if no token was used. */
    payment_method: PaymentLegacy.PaymentMethod | null;
    ...
    refunds: PaymentLegacy.Refunds.Item[];
    ...
    resolutions: PaymentLegacy.Resolutions.Item[] | null;
    ...
    shipping_address: PaymentLegacy.ShippingAddress | null;
...
export namespace PaymentLegacy {
    /**
     * The application fee charged on this payment.
     */
