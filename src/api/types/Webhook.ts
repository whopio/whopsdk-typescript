...
export interface Webhook {
    ...
    resource_id: string;
    testable_events: Webhook.TestableEvents.Item[];
...
export namespace Webhook {
    ...
    export type TestableEvents = TestableEvents.Item[];

    export namespace TestableEvents {
