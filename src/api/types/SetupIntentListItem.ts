...
export interface SetupIntentListItem {
    ...
    checkout_configuration: SetupIntentListItem.CheckoutConfiguration | null;
    /** The company that initiated this setup intent. Null if the company has been deleted. */
    company: SetupIntentListItem.Company | null;
    ...
    member: SetupIntentListItem.Member | null;
    ...
    payment_method: SetupIntentListItem.PaymentMethod | null;
    /** The current status of the setup intent. */
    status: Whop.SetupIntentStatuses;
}

export namespace SetupIntentListItem {
    /**
     * The checkout session configuration associated with this setup intent. Null if no checkout session was used.
     */
