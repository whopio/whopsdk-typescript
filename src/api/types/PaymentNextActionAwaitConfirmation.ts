...
export interface PaymentNextActionAwaitConfirmation {
    ...
    data: Whop.PaymentNextActionAwaitConfirmationData;
    render: PaymentNextActionAwaitConfirmation.Render.Item[];
}

export namespace PaymentNextActionAwaitConfirmation {
