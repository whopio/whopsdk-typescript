...
export interface SetupIntentLegacy {
    ...
    member: SetupIntentLegacy.Member | null;
    ...
    payment_method: SetupIntentLegacy.PaymentMethod | null;
...
export namespace SetupIntentLegacy {
    /**
     * The checkout session configuration associated with this setup intent. Null if no checkout session was used.
     */
