...
export interface PostProductUpdatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostProductUpdatedPayload.ApiVersion;
    ...
    type: PostProductUpdatedPayload.Type;
}

export namespace PostProductUpdatedPayload {
    /** The API version for this webhook */
