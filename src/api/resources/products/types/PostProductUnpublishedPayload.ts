...
export interface PostProductUnpublishedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostProductUnpublishedPayload.ApiVersion;
    ...
    type: PostProductUnpublishedPayload.Type;
}

export namespace PostProductUnpublishedPayload {
    /** The API version for this webhook */
