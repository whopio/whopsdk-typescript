...
export interface PostProductPublishedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostProductPublishedPayload.ApiVersion;
    ...
    type: PostProductPublishedPayload.Type;
}

export namespace PostProductPublishedPayload {
    /** The API version for this webhook */
