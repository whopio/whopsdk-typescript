...
export interface PostProductDeletedPayload {
    /** The API version for this webhook */
    api_version: PostProductDeletedPayload.ApiVersion;
    ...
    type: PostProductDeletedPayload.Type;
}

export namespace PostProductDeletedPayload {
    /** The API version for this webhook */
