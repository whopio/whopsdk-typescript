...
export interface PostCardTransactionCreatedPayload {
    /** The API version for this webhook */
    api_version: PostCardTransactionCreatedPayload.ApiVersion;
    ...
    type: PostCardTransactionCreatedPayload.Type;
}

export namespace PostCardTransactionCreatedPayload {
    /** The API version for this webhook */
