...
export interface PostCardTransactionReversedPayload {
    /** The API version for this webhook */
    api_version: PostCardTransactionReversedPayload.ApiVersion;
    ...
    type: PostCardTransactionReversedPayload.Type;
}

export namespace PostCardTransactionReversedPayload {
    /** The API version for this webhook */
