...
export interface PostCardTransactionDeclinedPayload {
    /** The API version for this webhook */
    api_version: PostCardTransactionDeclinedPayload.ApiVersion;
    ...
    type: PostCardTransactionDeclinedPayload.Type;
}

export namespace PostCardTransactionDeclinedPayload {
    /** The API version for this webhook */
