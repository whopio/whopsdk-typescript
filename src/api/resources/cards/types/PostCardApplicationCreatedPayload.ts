...
export interface PostCardApplicationCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostCardApplicationCreatedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    data: PostCardApplicationCreatedPayload.Data;
    ...
    type: PostCardApplicationCreatedPayload.Type;
}

export namespace PostCardApplicationCreatedPayload {
    /** The API version for this webhook */
