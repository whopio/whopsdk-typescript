...
export interface RetrieveCardsResponse {
    /** The billing address. */
    billing: RetrieveCardsResponse.Billing | null;
    ...
    limit: RetrieveCardsResponse.Limit | null;
    /** Card display name. */
    name: string | null;
    object: RetrieveCardsResponse.Object_;
    ...
    secrets?: (RetrieveCardsResponse.Secrets | null) | undefined;
    ...
    status: RetrieveCardsResponse.Status | null;
    /** The card type. */
    type: RetrieveCardsResponse.Type | null;
    /** Cardholder user ID, prefixed `user_`, when assigned. */
    user_id: string | null;
}

export namespace RetrieveCardsResponse {
    /**
     * The billing address.
     */
