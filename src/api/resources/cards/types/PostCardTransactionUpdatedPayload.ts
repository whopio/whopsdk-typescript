...
export interface PostCardTransactionUpdatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostCardTransactionUpdatedPayload.ApiVersion;
    ...
    type: PostCardTransactionUpdatedPayload.Type;
}

export namespace PostCardTransactionUpdatedPayload {
    /** The API version for this webhook */
