...
export interface UpdateCardsResponse {
    /** The billing address. */
    billing: UpdateCardsResponse.Billing | null;
    ...
    limit: UpdateCardsResponse.Limit | null;
    /** Card display name. */
    name: string | null;
    object: UpdateCardsResponse.Object_;
    ...
    secrets?: (UpdateCardsResponse.Secrets | null) | undefined;
    ...
    status: UpdateCardsResponse.Status | null;
    /** The card type. */
    type: UpdateCardsResponse.Type | null;
    /** Cardholder user ID, prefixed `user_`, when assigned. */
    user_id: string | null;
}

export namespace UpdateCardsResponse {
    /**
     * The billing address.
     */
