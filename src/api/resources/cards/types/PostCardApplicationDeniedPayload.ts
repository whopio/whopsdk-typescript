...
export interface PostCardApplicationDeniedPayload {
    /** The API version for this webhook */
    api_version: PostCardApplicationDeniedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    /** The account ID that this webhook event is associated with */
    company_id?: (string | null) | undefined;
    data: PostCardApplicationDeniedPayload.Data;
    ...
    type: PostCardApplicationDeniedPayload.Type;
}

export namespace PostCardApplicationDeniedPayload {
    /** The API version for this webhook */
