...
export interface PostCardTransactionCompletedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostCardTransactionCompletedPayload.ApiVersion;
    ...
    type: PostCardTransactionCompletedPayload.Type;
}

export namespace PostCardTransactionCompletedPayload {
    /** The API version for this webhook */
