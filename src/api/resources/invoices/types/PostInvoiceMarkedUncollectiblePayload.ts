...
export interface PostInvoiceMarkedUncollectiblePayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostInvoiceMarkedUncollectiblePayload.ApiVersion;
    ...
    type: PostInvoiceMarkedUncollectiblePayload.Type;
}

export namespace PostInvoiceMarkedUncollectiblePayload {
    /** The API version for this webhook */
