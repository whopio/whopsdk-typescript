...
export interface PostInvoicePaidPayload {
    /** The API version for this webhook */
    api_version: PostInvoicePaidPayload.ApiVersion;
    ...
    type: PostInvoicePaidPayload.Type;
}

export namespace PostInvoicePaidPayload {
    /** The API version for this webhook */
