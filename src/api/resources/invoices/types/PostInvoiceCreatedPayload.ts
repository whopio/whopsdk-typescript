...
export interface PostInvoiceCreatedPayload {
    /** The API version for this webhook */
    api_version: PostInvoiceCreatedPayload.ApiVersion;
    ...
    type: PostInvoiceCreatedPayload.Type;
}

export namespace PostInvoiceCreatedPayload {
    /** The API version for this webhook */
