...
export interface PostInvoiceVoidedPayload {
    /** The API version for this webhook */
    api_version: PostInvoiceVoidedPayload.ApiVersion;
    ...
    type: PostInvoiceVoidedPayload.Type;
}

export namespace PostInvoiceVoidedPayload {
    /** The API version for this webhook */
