...
export interface PostFinancialActivityFundsAvailablePayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostFinancialActivityFundsAvailablePayload.ApiVersion;
    ...
    type: PostFinancialActivityFundsAvailablePayload.Type;
}

export namespace PostFinancialActivityFundsAvailablePayload {
    /** The API version for this webhook */
