...
export interface PostLedgerAccountFundsAvailablePayload {
    /** The API version for this webhook */
    api_version: PostLedgerAccountFundsAvailablePayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    /** The account ID that this webhook event is associated with */
    company_id?: (string | null) | undefined;
    data: Whop.LedgerAccount;
    ...
    type: PostLedgerAccountFundsAvailablePayload.Type;
}

export namespace PostLedgerAccountFundsAvailablePayload {
    /** The API version for this webhook */
