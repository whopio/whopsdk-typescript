...
export class LinksClient {
     ...
     *
     * @param {Whop.partners.ListLinksRequest} request
     ...
     *
     * @example
     *     await client.partners.links.list()
     */
    public async list(
        request: Whop.partners.ListLinksRequest = {},
        requestOptions?: LinksClient.RequestOptions,
    ): Promise<core.Page<Whop.PartnerRewardLink, Whop.partners.ListLinksResponse>> {
        const list = core.HttpResponsePromise.interceptFunction(
            async (
                request: Whop.partners.ListLinksRequest,
            ): Promise<core.WithRawResponse<Whop.partners.ListLinksResponse>> => {
                const { status, first, after, last, before } = request;
                ...
                if (_response.ok) {
                    return {
                        data: _response.body as Whop.partners.ListLinksResponse,
        ...
        return new core.Page<Whop.PartnerRewardLink, Whop.partners.ListLinksResponse>({
