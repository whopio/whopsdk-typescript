...
export interface RetrievePayoutsResponse {
    ...
    failure: RetrievePayoutsResponse.Failure | null;
    ...
    fee_paid_by: RetrievePayoutsResponse.FeePaidBy;
    ...
    notes: string | null;
    object: RetrievePayoutsResponse.Object_;
    ...
    payout_method: RetrievePayoutsResponse.PayoutMethod | null;
    ...
    source: RetrievePayoutsResponse.Source | null;
    /** Payout delivery speed. */
    speed: RetrievePayoutsResponse.Speed;
...
export namespace RetrievePayoutsResponse {
    /**
     * Why the payout ended without paying, or why it reversed after settlement. Present on failed, canceled, denied, and reversed payouts; `null` otherwise.
     */
