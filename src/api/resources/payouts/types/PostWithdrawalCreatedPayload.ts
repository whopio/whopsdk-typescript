...
export interface PostWithdrawalCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostWithdrawalCreatedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    data: PostWithdrawalCreatedPayload.Data;
    ...
    type: PostWithdrawalCreatedPayload.Type;
}

export namespace PostWithdrawalCreatedPayload {
    /** The API version for this webhook */
