...
export interface PostWithdrawalUpdatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostWithdrawalUpdatedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    data: PostWithdrawalUpdatedPayload.Data;
    ...
    type: PostWithdrawalUpdatedPayload.Type;
}

export namespace PostWithdrawalUpdatedPayload {
    /** The API version for this webhook */
