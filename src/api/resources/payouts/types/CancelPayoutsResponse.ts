...
export interface CancelPayoutsResponse {
    ...
    failure: CancelPayoutsResponse.Failure | null;
    ...
    fee_paid_by: CancelPayoutsResponse.FeePaidBy;
    ...
    notes: string | null;
    object: CancelPayoutsResponse.Object_;
    ...
    payout_method: CancelPayoutsResponse.PayoutMethod | null;
...
export namespace CancelPayoutsResponse {
    /**
     * Why the payout ended without paying, or why it reversed after settlement. Present on failed, canceled, denied, and reversed payouts; `null` otherwise.
     */
