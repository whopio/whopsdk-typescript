...
export interface PostWithdrawalReversedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostWithdrawalReversedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    data: PostWithdrawalReversedPayload.Data;
    ...
    type: PostWithdrawalReversedPayload.Type;
}

export namespace PostWithdrawalReversedPayload {
    /** The API version for this webhook */
