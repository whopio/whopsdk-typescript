...
export interface PostChatMessageCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostChatMessageCreatedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    data: PostChatMessageCreatedPayload.Data;
    ...
    type: PostChatMessageCreatedPayload.Type;
}

export namespace PostChatMessageCreatedPayload {
    /** The API version for this webhook */
