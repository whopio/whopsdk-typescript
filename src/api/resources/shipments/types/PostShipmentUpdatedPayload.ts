...
export interface PostShipmentUpdatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostShipmentUpdatedPayload.ApiVersion;
    ...
    type: PostShipmentUpdatedPayload.Type;
}

export namespace PostShipmentUpdatedPayload {
    /** The API version for this webhook */
