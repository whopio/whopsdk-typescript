...
export interface PostShipmentCreatedPayload {
    /** The API version for this webhook */
    api_version: PostShipmentCreatedPayload.ApiVersion;
    ...
    type: PostShipmentCreatedPayload.Type;
}

export namespace PostShipmentCreatedPayload {
    /** The API version for this webhook */
