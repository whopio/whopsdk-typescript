...
export interface PostPaymentFailedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostPaymentFailedPayload.ApiVersion;
    ...
    type: PostPaymentFailedPayload.Type;
}

export namespace PostPaymentFailedPayload {
    /** The API version for this webhook */
