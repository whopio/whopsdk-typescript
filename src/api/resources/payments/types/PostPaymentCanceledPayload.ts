...
export interface PostPaymentCanceledPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostPaymentCanceledPayload.ApiVersion;
    ...
    type: PostPaymentCanceledPayload.Type;
}

export namespace PostPaymentCanceledPayload {
    /** The API version for this webhook */
