...
export interface PostPaymentRequiresActionPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostPaymentRequiresActionPayload.ApiVersion;
    ...
    type: PostPaymentRequiresActionPayload.Type;
}

export namespace PostPaymentRequiresActionPayload {
    /** The API version for this webhook */
