...
export interface PostPaymentSucceededPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostPaymentSucceededPayload.ApiVersion;
    ...
    type: PostPaymentSucceededPayload.Type;
}

export namespace PostPaymentSucceededPayload {
    /** The API version for this webhook */
