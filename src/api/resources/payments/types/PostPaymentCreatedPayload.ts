...
export interface PostPaymentCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostPaymentCreatedPayload.ApiVersion;
    ...
    type: PostPaymentCreatedPayload.Type;
}

export namespace PostPaymentCreatedPayload {
    /** The API version for this webhook */
