...
export interface PostSetupIntentSucceededPayload {
    /** The API version for this webhook */
    api_version: PostSetupIntentSucceededPayload.ApiVersion;
    ...
    type: PostSetupIntentSucceededPayload.Type;
}

export namespace PostSetupIntentSucceededPayload {
    /** The API version for this webhook */
