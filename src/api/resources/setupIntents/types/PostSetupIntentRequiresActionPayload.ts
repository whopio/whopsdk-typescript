...
export interface PostSetupIntentRequiresActionPayload {
    /** The API version for this webhook */
    api_version: PostSetupIntentRequiresActionPayload.ApiVersion;
    ...
    type: PostSetupIntentRequiresActionPayload.Type;
}

export namespace PostSetupIntentRequiresActionPayload {
    /** The API version for this webhook */
