...
export interface PostSwapCompletedPayload {
    /** The API version for this webhook */
    api_version: PostSwapCompletedPayload.ApiVersion;
    ...
    type: PostSwapCompletedPayload.Type;
}

export namespace PostSwapCompletedPayload {
    /** The API version for this webhook */
