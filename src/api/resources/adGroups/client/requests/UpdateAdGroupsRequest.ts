...
export interface UpdateAdGroupsRequest {
    ...
    bid_type?: UpdateAdGroupsRequest.BidType;
    ...
    budget_type?: UpdateAdGroupsRequest.BudgetType;
    ...
    frequency_cap?: UpdateAdGroupsRequest.FrequencyCap;
    ...
    message_apps?: UpdateAdGroupsRequest.MessageApps.Item[];
    ...
    optimization_goal?: UpdateAdGroupsRequest.OptimizationGoal;
    /**
     ...
     * - `whatsapp`: `status`
     */
    placements?: UpdateAdGroupsRequest.Placements;
    ...
    status?: UpdateAdGroupsRequest.Status;
    /** The display name of the ad group. */
    title?: string;
}

export namespace UpdateAdGroupsRequest {
    /** How delivery bids are set in the ad auction. Target-based strategies use `desired_cost_per_result`. */
