...
export interface PostVerificationSucceededPayload {
    /** The API version for this webhook */
    api_version: PostVerificationSucceededPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    /** The account ID that this webhook event is associated with */
    company_id?: (string | null) | undefined;
    data: Whop.Verification;
    ...
    type: PostVerificationSucceededPayload.Type;
}

export namespace PostVerificationSucceededPayload {
    /** The API version for this webhook */
