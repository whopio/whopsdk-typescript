...
export interface PostMembershipActivatedPayload {
    /** The API version for this webhook */
    api_version: PostMembershipActivatedPayload.ApiVersion;
    ...
    type: PostMembershipActivatedPayload.Type;
}

export namespace PostMembershipActivatedPayload {
    /** The API version for this webhook */
