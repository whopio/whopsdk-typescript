 ...
 */
export interface RetrieveTransfersResponse {
    /** Transfer amount. */
    amount: number;
    ...
    created_by_user: RetrieveTransfersResponse.CreatedByUser | null;
    /** Transfer currency. */
    currency: string;
    /** Account or user receiving funds. */
    destination: Whop.RetrieveTransfersResponseDestination;
    ...
    object: RetrieveTransfersResponse.Object_;
...
export namespace RetrieveTransfersResponse {
    /**
     * The user who initiated the transfer, such as the team member who sent a manual payout. Null if the creator is unavailable.
     */
