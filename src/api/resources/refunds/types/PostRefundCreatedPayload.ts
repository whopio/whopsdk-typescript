...
export interface PostRefundCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostRefundCreatedPayload.ApiVersion;
    ...
    type: PostRefundCreatedPayload.Type;
}

export namespace PostRefundCreatedPayload {
    /** The API version for this webhook */
