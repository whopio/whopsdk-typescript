...
export interface PostDisputeUpdatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostDisputeUpdatedPayload.ApiVersion;
    ...
    type: PostDisputeUpdatedPayload.Type;
}

export namespace PostDisputeUpdatedPayload {
    /** The API version for this webhook */
