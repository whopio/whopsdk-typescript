...
export interface PostAccountFinancingDeniedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostAccountFinancingDeniedPayload.ApiVersion;
    ...
    type: PostAccountFinancingDeniedPayload.Type;
}

export namespace PostAccountFinancingDeniedPayload {
    /** The API version for this webhook */
