...
export interface PostAccountFinancingApprovedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostAccountFinancingApprovedPayload.ApiVersion;
    ...
    type: PostAccountFinancingApprovedPayload.Type;
}

export namespace PostAccountFinancingApprovedPayload {
    /** The API version for this webhook */
