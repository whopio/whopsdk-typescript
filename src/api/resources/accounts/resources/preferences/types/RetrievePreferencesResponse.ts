...
export interface RetrievePreferencesResponse {
    ...
    ads_certifications: RetrievePreferencesResponse.AdsCertifications.Item[];
    ...
    subscription_failure_behavior: RetrievePreferencesResponse.SubscriptionFailureBehavior;
}
