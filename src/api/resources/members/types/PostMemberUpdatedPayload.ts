...
export interface PostMemberUpdatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostMemberUpdatedPayload.ApiVersion;
    ...
    type: PostMemberUpdatedPayload.Type;
}

export namespace PostMemberUpdatedPayload {
    /** The API version for this webhook */
