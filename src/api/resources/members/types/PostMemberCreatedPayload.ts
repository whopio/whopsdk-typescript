...
export interface PostMemberCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostMemberCreatedPayload.ApiVersion;
    ...
    type: PostMemberCreatedPayload.Type;
}

export namespace PostMemberCreatedPayload {
    /** The API version for this webhook */
