...
export interface PostEntryDeletedPayload {
    /** The API version for this webhook */
    api_version: PostEntryDeletedPayload.ApiVersion;
    ...
    type: PostEntryDeletedPayload.Type;
}

export namespace PostEntryDeletedPayload {
    /** The API version for this webhook */
