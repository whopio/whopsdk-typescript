...
export interface PostEntryDeniedPayload {
    /** The API version for this webhook */
    api_version: PostEntryDeniedPayload.ApiVersion;
    ...
    type: PostEntryDeniedPayload.Type;
}

export namespace PostEntryDeniedPayload {
    /** The API version for this webhook */
