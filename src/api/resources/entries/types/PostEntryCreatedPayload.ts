...
export interface PostEntryCreatedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostEntryCreatedPayload.ApiVersion;
    ...
    type: PostEntryCreatedPayload.Type;
}

export namespace PostEntryCreatedPayload {
    /** The API version for this webhook */
