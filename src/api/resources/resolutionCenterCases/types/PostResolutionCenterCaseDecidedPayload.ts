...
export interface PostResolutionCenterCaseDecidedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostResolutionCenterCaseDecidedPayload.ApiVersion;
    ...
    type: PostResolutionCenterCaseDecidedPayload.Type;
}

export namespace PostResolutionCenterCaseDecidedPayload {
    /** The API version for this webhook */
