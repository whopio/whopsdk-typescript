...
export interface PostExportFailedPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostExportFailedPayload.ApiVersion;
    ...
    type: PostExportFailedPayload.Type;
}

export namespace PostExportFailedPayload {
    /** The API version for this webhook */
