...
export interface PostExportCompletedPayload {
    /** The API version for this webhook */
    api_version: PostExportCompletedPayload.ApiVersion;
    ...
    type: PostExportCompletedPayload.Type;
}

export namespace PostExportCompletedPayload {
    /** The API version for this webhook */
