...
export interface PostDepositSucceededPayload {
    /** The account ID that this webhook event is associated with */
    account_id?: (string | null) | undefined;
    /** The API version for this webhook */
    api_version: PostDepositSucceededPayload.ApiVersion;
    ...
    type: PostDepositSucceededPayload.Type;
}

export namespace PostDepositSucceededPayload {
    /** The API version for this webhook */
