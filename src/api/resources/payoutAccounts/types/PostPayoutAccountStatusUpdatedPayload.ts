...
export interface PostPayoutAccountStatusUpdatedPayload {
    /** The API version for this webhook */
    api_version: PostPayoutAccountStatusUpdatedPayload.ApiVersion;
    /** The dated API version (Api-Version-Date) the payload is serialized to */
    api_version_date: string | null;
    /** The account ID that this webhook event is associated with */
    company_id?: (string | null) | undefined;
    data: Whop.PayoutAccount;
    ...
    type: PostPayoutAccountStatusUpdatedPayload.Type;
}

export namespace PostPayoutAccountStatusUpdatedPayload {
    /** The API version for this webhook */
