...
export type BaseClientOptions = {
    environment?: core.Supplier<environments.WhopEnvironment | environments.WhopEnvironmentUrls>;
    /** Specify a custom URL to connect the client to. */
    baseUrl?: core.Supplier<string>;
    /** Override the Api-Version-Date header */
    apiVersionDate?: core.Supplier<string | undefined>;
    /** Override the Idempotency-Key header */
    idempotencyKey?: core.Supplier<string | undefined>;
...
export interface BaseRequestOptions {
    ...
    /** Override the Api-Version-Date header */
    apiVersionDate?: string | undefined;
    /** Override the Idempotency-Key header */
    ...
    const headers = mergeHeaders(
        {
            ...
            "X-Fern-SDK-Name": "@whop/sdk",
            "X-Fern-SDK-Version": "1.1.5",
            "User-Agent": "@whop/sdk/1.1.5",
            "X-Fern-Runtime": core.RUNTIME.type,
            "X-Fern-Runtime-Version": core.RUNTIME.version,
            "Api-Version-Date": options?.apiVersionDate ?? "2026-09-22-3",
