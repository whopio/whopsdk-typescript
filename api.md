...
- <code title="post /wallets/{account_id}/sign-transaction">client.wallets.<a href="./src/resources/wallets.ts">signTransaction</a>(accountID, { ...params }) -> WalletSignTransactionResponse</code>
