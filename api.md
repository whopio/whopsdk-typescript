...
- <code title="get /wallets/{account_id}/deposit-address">client.wallets.<a href="./src/resources/wallets.ts">depositAddress</a>(accountID) -> WalletDepositAddressResponse</code>
