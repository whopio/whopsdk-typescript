...
export WHOP_API_VERSION="2026-07-08-1"
...
```
claude mcp add whop_mcp_api --env WHOP_API_KEY="My API Key" WHOP_WEBHOOK_SECRET="My Webhook Key" WHOP_APP_ID="app_xxxxxxxxxxxxxx" WHOP_API_VERSION="2026-07-08-1" -- npx -y @whop/mcp
```
