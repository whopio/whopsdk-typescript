...
const fuse = new Fuse(
  [
    ...
    'client.accounts.me',
    'client.accounts.recommendActions',
    ...
    'client.referrals.businesses.leaderboard',
    'client.referrals.businesses.list',
    'client.referrals.businesses.retrieve',
    'client.referrals.businesses.earnings.list',
    'client.referrals.partners.create',
    'client.cards.create',
    'client.cards.list',
    ...
    'client.workforce.bounties.retrieve',
