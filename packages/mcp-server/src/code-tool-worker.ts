...
const fuse = new Fuse(
  [
    ...
    'client.cards.cashback',
    'client.cards.create',
    'client.cards.createDispute',
    'client.cards.createDisputeAttachment',
    'client.cards.dailySpend',
    'client.cards.deactivate',
    'client.cards.depositAddress',
    'client.cards.freeze',
    'client.cards.list',
    'client.cards.pin',
    'client.cards.retrieve',
    'client.cards.secrets',
    'client.cards.transactions',
    'client.cards.unfreeze',
    'client.cards.update',
    'client.cards.updatePin',
    'client.cardAccount.update',
