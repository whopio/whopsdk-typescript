...
const remoteStainlessHandler = async (
  ...
  WHOP_API_KEY: requireValue(readEnv('WHOP_API_KEY') ?? client.apiKey, 'set WHOP_API_KEY environment variable or provide apiKey client option'),
