...
export const handler = async (client: Whop, args: Record<string, unknown> | undefined) => {
  ...
  const response = await client.paymentTokens.list(body).asResponse();
  try {
