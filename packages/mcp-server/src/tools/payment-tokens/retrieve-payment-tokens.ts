...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      member_id: {
        type: 'string',
        description: 'The ID of the Member associated with the PaymentToken',
      },
      jq_filter: {
        type: 'string',
        title: 'jq Filter',
...
export const handler = async (client: Whop, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.paymentTokens.retrieve(id, body)));
  } catch (error) {
