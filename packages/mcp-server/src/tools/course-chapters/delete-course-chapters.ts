...
export const tool: Tool = {
  name: 'delete_course_chapters',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nDeletes a course chapter\n\nRequired permissions:\n - `courses:update`\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/course_chapter_delete_response',\n  $defs: {\n    course_chapter_delete_response: {\n      type: 'boolean',\n      description: 'Represents `true` or `false` values.'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export const handler = async (client: Whop, args: Record<string, unknown> | undefined) => {
  ...
  return asTextContentResult(await maybeFilter(jq_filter, await client.courseChapters.delete(id)));
};
