...
export const tool: Tool = {
  ...
  inputSchema: {
    ...
    properties: {
      company_id: {
        type: 'string',
        description: 'The ID of the company to create the shipment for',
      },
      payment_id: {
        type: 'string',
        description: 'The ID of the payment to create the shipment for',
      },
      tracking_code: {
        type: 'string',
    ...
    required: ['company_id', 'payment_id', 'tracking_code'],
  },
  annotations: {},
};
