...
export const tool: Tool = {
  name: 'delete_fee_markups',
  description:
    "When using this tool, always use the `jq_filter` parameter to reduce the response size and improve performance.\n\nOnly omit if you're sure you don't need the data.\n\nDeletes a fee markup for a company.\n\nRequired permissions:\n - `company:update_child_fees`\n\n# Response Schema\n```json\n{\n  $ref: '#/$defs/fee_markup_delete_response',\n  $defs: {\n    fee_markup_delete_response: {\n      type: 'boolean',\n      description: 'Represents `true` or `false` values.'\n    }\n  }\n}\n```",
  inputSchema: {
    type: 'object',
    properties: {
      id: {
...
export const handler = async (client: Whop, args: Record<string, unknown> | undefined) => {
  ...
  try {
    return asTextContentResult(await maybeFilter(jq_filter, await client.feeMarkups.delete(id)));
  } catch (error) {
