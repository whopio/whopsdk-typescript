...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; current_plan: { id: string; currency: string; formatted_price: string; }; due_date: string; email_address: string; fetch_invoice_token: string; number: string; status: 'draft' | 'open' | 'paid' | 'past_due' | 'uncollectible' | 'void'; user: { id: string; name: string; username: string; }; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/invoices/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/invoices/$ID/void \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/invoices/$ID/mark_paid \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/invoices/$ID/mark_uncollectible \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; completed: boolean; created_at: string; lesson: { id: string; chapter: { id: string; }; title: string; }; user: { id: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lesson_interactions \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; completed: boolean; course: { id: string; experience: { id: string; }; title: string; }; created_at: string; lesson: { id: string; chapter: { id: string; }; title: string; }; user: { id: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lesson_interactions/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; external_identifier: string; headline: string; member_count: number; published_reviews_count: number; route: string; title: string; updated_at: string; verified: boolean; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/products/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; affiliate_instructions: string; created_at: string; description: string; featured_affiliate_product: { id: string; name: string; }; logo: { url: string; }; member_count: number; metadata: object; owner_user: { id: string; name: string; username: string; }; published_reviews_count: number; route: string; send_customer_emails: boolean; social_links: { id: string; url: string; website: 'x' | 'instagram' | 'facebook' | 'tiktok' | 'youtube' | 'linkedin' | 'twitch' | 'website' | 'custom'; }[]; target_audience: string; title: string; updated_at: string; verified: boolean; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/companies/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; description: string; logo: { url: string; }; member_count: number; metadata: object; owner_user: { id: string; name: string; username: string; }; published_reviews_count: number; route: string; send_customer_emails: boolean; target_audience: string; title: string; updated_at: string; verified: boolean; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/companies \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; api_version: 'v1' | 'v2' | 'v5'; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; url: string; }",
  ...
  },
  {
    ...
    "response": "{ id: string; api_version: 'v1' | 'v2' | 'v5'; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; testable_events: string[]; url: string; webhook_secret: string; }",
  ...
  },
  {
    ...
    "response": "{ id: string; api_version: 'v1' | 'v2' | 'v5'; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; testable_events: string[]; url: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/webhooks/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "httpMethod": "get",
    "summary": "List plans",
    "description": "Returns a paginated list of plans belonging to a company, with optional filtering by visibility, type, release method, and product.\n\nRequired permissions:\n - `plan:basic:read`",
  ...
  },
  {
    ...
    "params": [
      ...
      "product_id: string;",
      "billing_period?: number;",
      "checkout_styling?: { border_style?: 'rounded' | 'pill' | 'rectangular'; button_color?: string; font_family?: 'system' | 'roboto' | 'open_sans'; };",
      "currency?: string;",
      "custom_fields?: { field_type: 'text'; name: string; id?: string; order?: number; placeholder?: string; required?: boolean; }[];",
      "description?: string;",
      "expiration_days?: number;",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/plans/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; plan: { id: string; }; product: { id: string; title: string; }; status: 'drafted' | 'pending' | 'approved' | 'denied' | 'any'; user: { id: string; email: string; name: string; username: string; }; }",
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; custom_field_responses: { id: string; answer: string; question: string; }[]; plan: { id: string; }; product: { id: string; title: string; }; status: 'drafted' | 'pending' | 'approved' | 'denied' | 'any'; user: { id: string; email: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/entries/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/entries/$ID/approve \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/entries/$ID/deny \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/forum_posts \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/forum_posts/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; amount: number; created_at: string; currency: string; destination_ledger_account_id: string; fee_amount: number; metadata: object; notes: string; origin_ledger_account_id: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/transfers \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/transfers/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/ledger_accounts/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships/$ID/cancel \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships/$ID/pause \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships/$ID/resume \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships/$ID/uncancel \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/memberships/$ID/add_free_days \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"free_days\": 42\n        }'"
      }
    }
  },
  {
    ...
    "params": [
      ...
      "first?: number;",
      "last?: number;",
      "role?: 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'app_manager' | 'support' | 'manager' | 'custom';",
      "user_id?: string;"
    ],
    "response": "{ id: string; company: { id: string; title: string; }; role: 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'app_manager' | 'support' | 'manager' | 'custom'; user: { id: string; email: string; name: string; username: string; }; }",
    "markdown": "## list\n\n`client.authorizedUsers.list(after?: string, before?: string, company_id?: string, created_after?: string, created_before?: string, first?: number, last?: number, role?: 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'app_manager' | 'support' | 'manager' | 'custom', user_id?: string): { id: string; company: object; role: authorized_user_roles; user: object; }`\n\n**get** `/authorized_users`\n\nReturns a paginated list of authorized team members for a company, with optional filtering by user, role, and creation date.\n\nRequired permissions:\n - `company:authorized_user:read`\n - `member:email:read`\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `company_id?: string`\n  The unique identifier of the company to list authorized users for.\n\n- `created_after?: string`\n  Only return authorized users created after this timestamp.\n\n- `created_before?: string`\n  Only return authorized users created before this timestamp.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `role?: 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'app_manager' | 'support' | 'manager' | 'custom'`\n  Possible roles an authorized user can have\n\n- `user_id?: string`\n  Filter results to a specific user to check if they are an authorized team member.\n\n### Returns\n\n- `{ id: string; company: { id: string; title: string; }; role: 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'app_manager' | 'support' | 'manager' | 'custom'; user: { id: string; email: string; name: string; username: string; }; }`\n  A user who has been granted administrative access to manage a company's dashboard and settings.\n\n  - `id: string`\n  - `company: { id: string; title: string; }`\n  - `role: 'owner' | 'admin' | 'sales_manager' | 'moderator' | 'app_manager' | 'support' | 'manager' | 'custom'`\n  - `user: { id: string; email: string; name: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const authorizedUserListResponse of client.authorizedUsers.list()) {\n  console.log(authorizedUserListResponse);\n}\n```",
    "perLanguage": {
      "typescript": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/authorized_users \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/authorized_users/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: 'ios' | 'android' | 'web'; review_message: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/app_builds \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/app_builds/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/app_builds/$ID/promote \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; carrier: string; created_at: string; delivery_estimate: string; payment: { id: string; }; service: string; status: string; substatus: string; tracking_code: string; updated_at: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/shipments \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/shipments/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/checkout_configurations \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/checkout_configurations/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/messages/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; ban_media: boolean; ban_urls: boolean; banned_words: string[]; experience: { id: string; name: string; }; user_posts_cooldown_seconds: number; who_can_post: 'everyone' | 'admins'; who_can_react: 'everyone' | 'no_one'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/chat_channels \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/chat_channels/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; bio: string; created_at: string; name: string; profile_picture: { url: string; }; username: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/users/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/users/$ID/access/$RESOURCE_ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "httpMethod": "get",
    "summary": "List users",
    "description": "Search for users by name or username, ranked by social proximity to the authenticated user.",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payments/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payments/$ID/refund \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payments/$ID/retry \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payments/$ID/void \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payments/$ID/fees \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; company_id: string; custom_name: string; customer_user: { id: string; name: string; username: string; }; last_message_at: string; resolved_at: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/support_channels \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/support_channels/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; app: { id: string; icon: { url: string; }; name: string; }; company: { id: string; route: string; title: string; }; created_at: string; image: { url: string; }; is_public: boolean; name: string; order: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/experiences \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; app: { id: string; icon: { url: string; }; name: string; }; company: { id: string; route: string; title: string; }; created_at: string; image: { url: string; }; is_public: boolean; name: string; order: string; products: { id: string; route: string; title: string; }[]; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/experiences/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/experiences/$ID/attach \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"product_id\": \"prod_xxxxxxxxxxxxx\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/experiences/$ID/detach \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"product_id\": \"prod_xxxxxxxxxxxxx\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/experiences/$ID/duplicate \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; emoji: string; resource_id: string; user: { id: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/reactions \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/reactions/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/members/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; email_notification_preference: 'all_admin_posts' | 'only_weekly_summary' | 'none'; experience: { id: string; name: string; }; who_can_comment: 'everyone' | 'admins'; who_can_post: 'everyone' | 'admins'; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/forums/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/promo_codes \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/promo_codes/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/courses/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_chapters \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; lessons: { id: string; order: number; title: string; }[]; order: number; title: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_chapters/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; content: string; created_at: string; days_from_course_start_until_unlock: number; embed_id: string; embed_type: 'youtube' | 'loom'; lesson_type: 'text' | 'video' | 'pdf' | 'multi' | 'quiz' | 'knowledge_check'; order: number; thumbnail: { url: string; }; title: string; visibility: 'visible' | 'hidden'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lessons \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lessons/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lessons/$LESSON_ID/mark_as_completed \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lessons/$LESSON_ID/start \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_lessons/$LESSON_ID/submit_assessment \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"answers\": [\n            {\n              \"question_id\": \"question_id\"\n            }\n          ]\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; attachments: { id: string; content_type: string; filename: string; url: string; }[]; created_at: string; description: string; joined_at: string; paid_for_product: boolean; published_at: string; stars: number; status: 'pending' | 'published' | 'removed'; title: string; updated_at: string; user: { id: string; name: string; username: string; }; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/reviews/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; completed_lessons_count: number; completion_rate: number; first_interaction_at: string; last_interaction_at: string; total_lessons_count: number; user: { id: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_students \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; completed_lessons_count: number; completion_rate: number; course: { id: string; experience: { id: string; }; title: string; }; first_interaction_at: string; last_interaction_at: string; total_lessons_count: number; user: { id: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/course_students/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/access_tokens \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/notifications \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"company_id\": \"biz_xxxxxxxxxxxxxx\",\n          \"content\": \"content\",\n          \"title\": \"title\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; amount: number; company: { id: string; title: string; }; created_at: string; currency: string; editable: boolean; needs_response_by: string; payment: { id: string; }; plan: { id: string; }; product: { id: string; title: string; }; reason: string; status: string; visa_rdr: boolean; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/disputes/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/disputes/$ID/submit_evidence \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/disputes/$ID/update_evidence \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/refunds/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; amount: number; created_at: string; currency: string; fee_amount: number; fee_type: 'exclusive' | 'inclusive'; markup_fee: number; speed: 'standard' | 'instant'; status: 'requested' | 'awaiting_payment' | 'in_transit' | 'completed' | 'failed' | 'canceled' | 'denied'; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/withdrawals \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/withdrawals/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/account_links \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"company_id\": \"biz_xxxxxxxxxxxxxx\",\n          \"refresh_url\": \"refresh_url\",\n          \"return_url\": \"return_url\",\n          \"use_case\": \"account_onboarding\"\n        }'"
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/setup_intents \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/setup_intents/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payment_methods \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payment_methods/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; fee_type: string; fixed_fee_usd: number; notes: string; percentage_fee: number; updated_at: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/fee_markups \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/fee_markups/$ID \\\n    -X DELETE \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; account_reference: string; company: { id: string; }; created_at: string; currency: string; destination: { category: 'crypto' | 'rtp' | 'next_day_bank' | 'bank_wire' | 'digital_wallet' | 'unknown'; country_code: string; name: string; }; institution_name: string; is_default: boolean; nickname: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payout_methods \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payout_methods/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/verifications/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/verifications \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; created_at: string; member: { id: string; }; metadata: object; product: { id: string; title: string; }; referrer: string; updated_at: string; user: { id: string; email: string; name: string; username: string; }; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/leads/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; created_at: string; currency: string; failure_message: string; paid_at: string; status: 'draft' | 'open' | 'paid' | 'pending' | 'uncollectible' | 'unresolved' | 'void'; total: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/topups \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"amount\": 6.9,\n          \"company_id\": \"biz_xxxxxxxxxxxxxx\",\n          \"currency\": \"usd\",\n          \"payment_method_id\": \"pmt_xxxxxxxxxxxxxx\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; content_type: string; filename: string; size: string; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; url: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/files/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; content_type: string; filename: string; size: string; upload_headers: object; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; upload_url: string; url: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/files \\\n    -H 'Content-Type: application/json' \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\" \\\n    -d '{\n          \"filename\": \"filename\"\n        }'"
      }
    }
  },
  {
    ...
    "response": "{ id: string; amount: number; company: { id: string; route: string; title: string; }; created_at: string; description: string; idempotency_key: string; linked_transaction_id: string; member: { id: string; }; transaction_type: 'add' | 'subtract' | 'transfer'; user: { id: string; name: string; username: string; }; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/company_token_transactions \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/company_token_transactions/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; channel_id: string; last_viewed_at: string; status: 'requested' | 'accepted' | 'hidden' | 'closed' | 'archived'; user_id: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/dm_members \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; channel_id: string; last_viewed_at: string; notification_preference: 'all' | 'mentions' | 'none'; status: 'requested' | 'accepted' | 'hidden' | 'closed' | 'archived'; user_id: string; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/dm_members/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; blended_token_usage: string; created_at: string; last_message_at: string; message_count: number; notification_preference: 'all' | 'none'; title: string; updated_at: string; user: { id: string; }; }",
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/ai_chats/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/dm_channels \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/dm_channels/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "response": "{ id: string; alert_type: 'dispute' | 'dispute_rdr' | 'fraud'; amount: number; charge_for_alert: boolean; created_at: string; currency: string; dispute: { id: string; }; payment: { id: string; }; transaction_date: string; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/dispute_alerts \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/dispute_alerts/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/resolution_center_cases \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/resolution_center_cases/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/payout_accounts/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/affiliates \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/affiliates/$ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/affiliates/$ID/archive \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/affiliates/$ID/unarchive \\\n    -X POST \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
    ...
    "response": "{ id: string; applies_to_payments: 'first_payment' | 'all_payments'; applies_to_products: 'single_product' | 'all_products'; checkout_direct_link: string; commission_type: 'percentage' | 'flat_fee'; commission_value: number; override_type: 'standard' | 'rev_share'; plan_id: string; product_direct_link: string; product_id: string; revenue_basis: 'pre_fees' | 'post_fees'; total_referral_earnings_usd: number; }",
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/affiliates/$ID/overrides \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
  ...
  },
  {
    ...
    "perLanguage": {
      ...
      "http": {
        "example": "curl https://api.whop.com/api/v1/affiliates/$ID/overrides/$OVERRIDE_ID \\\n    -H \"Authorization: Bearer $WHOP_API_KEY\""
      }
    }
  },
  {
