...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    params: [
      "{ company_id: string; confirmation_token: string; plan: { currency: string; application_fee_amount?: number; billing_period?: number; description?: string; expiration_days?: number; force_create_new_plan?: boolean; initial_price?: number; internal_notes?: string; plan_type?: 'renewal' | 'one_time'; product?: { external_identifier: string; title: string; collect_shipping_address?: boolean; custom_statement_descriptor?: string; description?: string; global_affiliate_percentage?: number; global_affiliate_status?: 'enabled' | 'disabled'; headline?: string; product_tax_code_id?: string; redirect_purchase_url?: string; route?: string; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; product_id?: string; renewal_price?: number; title?: string; trial_period_days?: number; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; } | { company_id: string; member_id: string; plan: { currency: string; application_fee_amount?: number; billing_period?: number; description?: string; expiration_days?: number; force_create_new_plan?: boolean; initial_price?: number; internal_notes?: string; plan_type?: 'renewal' | 'one_time'; product?: { external_identifier: string; title: string; collect_shipping_address?: boolean; custom_statement_descriptor?: string; description?: string; global_affiliate_percentage?: number; global_affiliate_status?: 'enabled' | 'disabled'; headline?: string; product_tax_code_id?: string; redirect_purchase_url?: string; route?: string; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; product_id?: string; renewal_price?: number; title?: string; trial_period_days?: number; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; } | { company_id: string; confirmation_token: string; plan_id: string; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; } | { company_id: string; member_id: string; plan_id: string; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; };",
    ],
    response: 'object',
    perLanguage: {
      typescript: {
