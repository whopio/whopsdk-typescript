...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    markdown:
      "## retrieve\n\n`client.files.retrieve(id: string): { id: string; content_type: string; filename: string; size: string; upload_status: upload_status; url: string; visibility: 'public' | 'private'; }`\n\n**get** `/files/{id}`\n\nRetrieves the details of an existing file.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; content_type: string; filename: string; size: string; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; url: string; visibility: 'public' | 'private'; }`\n  A file that has been uploaded or is pending upload.\n\n  - `id: string`\n  - `content_type: string`\n  - `filename: string`\n  - `size: string`\n  - `upload_status: 'pending' | 'processing' | 'ready' | 'failed'`\n  - `url: string`\n  - `visibility: 'public' | 'private'`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst file = await client.files.retrieve('file_xxxxxxxxxxxxx');\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
