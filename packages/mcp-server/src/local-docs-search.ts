...
const EMBEDDED_METHODS: MethodEntry[] = [
  {
    ...
    response:
      "{ id: string; app_type: 'b2b_app' | 'b2c_app' | 'company_app' | 'component' | 'website'; base_url: string; company: { id: string; title: string; }; creator: { id: string; name: string; username: string; }; dashboard_path: string; description: string; discover_path: string; domain_id: string; experience_path: string; hosted_url: string; icon: { url: string; }; name: string; openapi_path: string; origin: string; route: string; skills_path: string; status: 'live' | 'unlisted' | 'hidden'; verified: boolean; }",
    markdown:
