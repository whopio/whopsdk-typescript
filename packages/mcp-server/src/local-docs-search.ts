...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ accounts: { id: string; banner_image_url: string; business_type: string; country: string; created_at: string; description: string; email: string; home_preferences: string[]; industry_group: string; industry_type: string; invoice_prefix: string; logo_url: string; metadata: object; onboarding_type: string; opengraph_image_url: string; opengraph_image_variant: string; other_business_description: string; other_industry_description: string; parent_account_id: string; require_2fa: boolean; route: string; send_customer_emails: boolean; show_joined_whops: boolean; show_reviews_dtc: boolean; show_user_directory: boolean; social_links: account_social_link[]; store_page_config: object; target_audience: string; title: string; use_logo_as_opengraph_image_fallback: boolean; wallet: account_wallet; }[]; pagination: { current_page: number; next_page: number; prev_page: number; total_count: number; total_pages: number; }; }',
    markdown:
      "## list\n\n`client.accounts.list(page?: number, per?: number): { accounts: account[]; pagination: object; }`\n\n**get** `/accounts`\n\nLists accounts visible to the credential. User tokens return the user's business accounts; business account API keys return the requesting business account and its connected accounts.\n\n### Parameters\n\n- `page?: number`\n  The page number to retrieve\n\n- `per?: number`\n  The number of resources to return per page. There is a limit of 50 results per page.\n\n### Returns\n\n- `{ accounts: { id: string; banner_image_url: string; business_type: string; country: string; created_at: string; description: string; email: string; home_preferences: string[]; industry_group: string; industry_type: string; invoice_prefix: string; logo_url: string; metadata: object; onboarding_type: string; opengraph_image_url: string; opengraph_image_variant: string; other_business_description: string; other_industry_description: string; parent_account_id: string; require_2fa: boolean; route: string; send_customer_emails: boolean; show_joined_whops: boolean; show_reviews_dtc: boolean; show_user_directory: boolean; social_links: account_social_link[]; store_page_config: object; target_audience: string; title: string; use_logo_as_opengraph_image_fallback: boolean; wallet: account_wallet; }[]; pagination: { current_page: number; next_page: number; prev_page: number; total_count: number; total_pages: number; }; }`\n\n  - `accounts: { id: string; banner_image_url: string; business_type: string; country: string; created_at: string; description: string; email: string; home_preferences: string[]; industry_group: string; industry_type: string; invoice_prefix: string; logo_url: string; metadata: object; onboarding_type: string; opengraph_image_url: string; opengraph_image_variant: string; other_business_description: string; other_industry_description: string; parent_account_id: string; require_2fa: boolean; route: string; send_customer_emails: boolean; show_joined_whops: boolean; show_reviews_dtc: boolean; show_user_directory: boolean; social_links: { id: string; title: string; url: string; website: 'x' | 'instagram' | 'facebook' | 'tiktok' | 'youtube' | 'linkedin' | 'twitch' | 'website' | 'custom'; }[]; store_page_config: object; target_audience: string; title: string; use_logo_as_opengraph_image_fallback: boolean; wallet: { id: string; address: string; network: 'solana' | 'ethereum' | 'bitcoin'; }; }[]`\n  - `pagination: { current_page: number; next_page: number; prev_page: number; total_count: number; total_pages: number; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst accounts = await client.accounts.list();\n\nconsole.log(accounts);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'retrieve',
    endpoint: '/ad_campaigns/{id}',
    httpMethod: 'get',
    summary: 'Retrieve ad campaign',
    description:
      'Retrieves a single ad campaign by its unique identifier.\n\nRequired permissions:\n - `ad_campaign:basic:read`',
    stainlessPath: '(resource) ad_campaigns > (method) retrieve',
    qualified: 'client.adCampaigns.retrieve',
    params: ['id: string;'],
    response:
      "{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }",
    markdown:
      "## retrieve\n\n`client.adCampaigns.retrieve(id: string): { id: string; budget: number; budget_type: ad_budget_type; created_at: string; created_by_user: object; meta_config: object; platform: ad_campaign_platform; status: ad_campaign_status; title: string; total_spend: number; updated_at: string; }`\n\n**get** `/ad_campaigns/{id}`\n\nRetrieves a single ad campaign by its unique identifier.\n\nRequired permissions:\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }`\n  An advertising campaign running on an external platform or within Whop.\n\n  - `id: string`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `created_by_user: { id: string; name: string; username: string; }`\n  - `meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'`\n  - `title: string`\n  - `total_spend: number`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adCampaign = await client.adCampaigns.retrieve('adcamp_xxxxxxxxxxx');\n\nconsole.log(adCampaign);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) ad_campaigns > (method) update',
    qualified: 'client.adCampaigns.update',
    params: ['id: string;', 'budget?: number;'],
    response:
      "{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }",
    markdown:
      "## update\n\n`client.adCampaigns.update(id: string, budget?: number): { id: string; budget: number; budget_type: ad_budget_type; created_at: string; created_by_user: object; meta_config: object; platform: ad_campaign_platform; status: ad_campaign_status; title: string; total_spend: number; updated_at: string; }`\n\n**patch** `/ad_campaigns/{id}`\n\nUpdates an ad campaign synchronously.\n\nRequired permissions:\n - `ad_campaign:update`\n\n### Parameters\n\n- `id: string`\n\n- `budget?: number`\n  The campaign budget in dollars. The interpretation (daily or lifetime) follows the campaign's existing budget type.\n\n### Returns\n\n- `{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }`\n  An advertising campaign running on an external platform or within Whop.\n\n  - `id: string`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `created_by_user: { id: string; name: string; username: string; }`\n  - `meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'`\n  - `title: string`\n  - `total_spend: number`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adCampaign = await client.adCampaigns.update('adcamp_xxxxxxxxxxx');\n\nconsole.log(adCampaign);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'pause',
    endpoint: '/ad_campaigns/{id}/pause',
    httpMethod: 'post',
    summary: 'Pause ad campaign',
    description:
      'Pauses an ad campaign, optionally until a specific date.\n\nRequired permissions:\n - `ad_campaign:update`',
    stainlessPath: '(resource) ad_campaigns > (method) pause',
    qualified: 'client.adCampaigns.pause',
    params: ['id: string;'],
    response:
      "{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }",
    markdown:
      "## pause\n\n`client.adCampaigns.pause(id: string): { id: string; budget: number; budget_type: ad_budget_type; created_at: string; created_by_user: object; meta_config: object; platform: ad_campaign_platform; status: ad_campaign_status; title: string; total_spend: number; updated_at: string; }`\n\n**post** `/ad_campaigns/{id}/pause`\n\nPauses an ad campaign, optionally until a specific date.\n\nRequired permissions:\n - `ad_campaign:update`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }`\n  An advertising campaign running on an external platform or within Whop.\n\n  - `id: string`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `created_by_user: { id: string; name: string; username: string; }`\n  - `meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'`\n  - `title: string`\n  - `total_spend: number`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adCampaign = await client.adCampaigns.pause('adcamp_xxxxxxxxxxx');\n\nconsole.log(adCampaign);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'unpause',
    endpoint: '/ad_campaigns/{id}/unpause',
    httpMethod: 'post',
    summary: 'Unpause ad campaign',
    description: 'Resumes a paused ad campaign.\n\nRequired permissions:\n - `ad_campaign:update`',
    stainlessPath: '(resource) ad_campaigns > (method) unpause',
    qualified: 'client.adCampaigns.unpause',
    params: ['id: string;'],
    response:
      "{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }",
    markdown:
      "## unpause\n\n`client.adCampaigns.unpause(id: string): { id: string; budget: number; budget_type: ad_budget_type; created_at: string; created_by_user: object; meta_config: object; platform: ad_campaign_platform; status: ad_campaign_status; title: string; total_spend: number; updated_at: string; }`\n\n**post** `/ad_campaigns/{id}/unpause`\n\nResumes a paused ad campaign.\n\nRequired permissions:\n - `ad_campaign:update`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; created_by_user: { id: string; name: string; username: string; }; meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'; title: string; total_spend: number; updated_at: string; }`\n  An advertising campaign running on an external platform or within Whop.\n\n  - `id: string`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `created_by_user: { id: string; name: string; username: string; }`\n  - `meta_config: { bid_amount: number; bid_strategy: 'lowest_cost' | 'bid_cap' | 'cost_cap'; budget_optimization: boolean; effective_status: 'active' | 'paused' | 'deleted' | 'in_review' | 'rejected' | 'with_issues'; end_time: string; objective: 'awareness' | 'traffic' | 'engagement' | 'leads' | 'sales'; special_categories: string[]; start_time: string; status: 'active' | 'paused'; }`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'payment_failed' | 'draft' | 'in_review' | 'flagged'`\n  - `title: string`\n  - `total_spend: number`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adCampaign = await client.adCampaigns.unpause('adcamp_xxxxxxxxxxx');\n\nconsole.log(adCampaign);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) ad_groups > (method) list',
    qualified: 'client.adGroups.list',
    params: [
      'after?: string;',
      'before?: string;',
      'campaign_id?: string;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) ad_groups > (method) retrieve',
    qualified: 'client.adGroups.retrieve',
    params: ['id: string;'],
    response:
      "{ id: string; ad_campaign: { id: string; }; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }",
    markdown:
      "## retrieve\n\n`client.adGroups.retrieve(id: string): { id: string; ad_campaign: object; budget: number; budget_type: ad_budget_type; created_at: string; platform: ad_campaign_platform; status: ad_group_status; title: string; updated_at: string; }`\n\n**get** `/ad_groups/{id}`\n\nRetrieves a single ad group by its unique identifier.\n\nRequired permissions:\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; ad_campaign: { id: string; }; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }`\n  An ad group (ad set) belonging to an ad campaign.\n\n  - `id: string`\n  - `ad_campaign: { id: string; }`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'`\n  - `title: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adGroup = await client.adGroups.retrieve('adgrp_xxxxxxxxxxxx');\n\nconsole.log(adGroup);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) ad_groups > (method) update',
    qualified: 'client.adGroups.update',
    params: [
      'id: string;',
      'budget?: number;',
      "budget_type?: 'daily' | 'lifetime';",
  ...
  {
    name: 'pause',
    endpoint: '/ad_groups/{id}/pause',
    httpMethod: 'post',
    summary: 'Pause ad group',
    description:
      'Pauses an ad group.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`',
    stainlessPath: '(resource) ad_groups > (method) pause',
    qualified: 'client.adGroups.pause',
    params: ['id: string;'],
    response:
      "{ id: string; ad_campaign: { id: string; }; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }",
    markdown:
      "## pause\n\n`client.adGroups.pause(id: string): { id: string; ad_campaign: object; budget: number; budget_type: ad_budget_type; created_at: string; platform: ad_campaign_platform; status: ad_group_status; title: string; updated_at: string; }`\n\n**post** `/ad_groups/{id}/pause`\n\nPauses an ad group.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; ad_campaign: { id: string; }; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }`\n  An ad group (ad set) belonging to an ad campaign.\n\n  - `id: string`\n  - `ad_campaign: { id: string; }`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'`\n  - `title: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adGroup = await client.adGroups.pause('adgrp_xxxxxxxxxxxx');\n\nconsole.log(adGroup);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'unpause',
    endpoint: '/ad_groups/{id}/unpause',
    httpMethod: 'post',
    summary: 'Unpause ad group',
    description:
      'Resumes a paused ad group.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`',
    stainlessPath: '(resource) ad_groups > (method) unpause',
    qualified: 'client.adGroups.unpause',
    params: ['id: string;'],
    response:
      "{ id: string; ad_campaign: { id: string; }; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }",
    markdown:
      "## unpause\n\n`client.adGroups.unpause(id: string): { id: string; ad_campaign: object; budget: number; budget_type: ad_budget_type; created_at: string; platform: ad_campaign_platform; status: ad_group_status; title: string; updated_at: string; }`\n\n**post** `/ad_groups/{id}/unpause`\n\nResumes a paused ad group.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; ad_campaign: { id: string; }; budget: number; budget_type: 'daily' | 'lifetime'; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }`\n  An ad group (ad set) belonging to an ad campaign.\n\n  - `id: string`\n  - `ad_campaign: { id: string; }`\n  - `budget: number`\n  - `budget_type: 'daily' | 'lifetime'`\n  - `created_at: string`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'`\n  - `title: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst adGroup = await client.adGroups.unpause('adgrp_xxxxxxxxxxxx');\n\nconsole.log(adGroup);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) ads > (method) list',
    qualified: 'client.ads.list',
    params: [
      'ad_group_id?: string;',
      'after?: string;',
      'before?: string;',
  ...
  },
  {
    ...
    stainlessPath: '(resource) ads > (method) retrieve',
    qualified: 'client.ads.retrieve',
    params: ['id: string;'],
    response:
      "{ id: string; ad_campaign: { id: string; }; ad_group: { id: string; }; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }",
    markdown:
      "## retrieve\n\n`client.ads.retrieve(id: string): { id: string; ad_campaign: object; ad_group: object; created_at: string; platform: ad_campaign_platform; status: external_ad_status; title: string; updated_at: string; }`\n\n**get** `/ads/{id}`\n\nRetrieve an ad by its unique identifier.\n\nRequired permissions:\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; ad_campaign: { id: string; }; ad_group: { id: string; }; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }`\n  An ad belonging to an ad group.\n\n  - `id: string`\n  - `ad_campaign: { id: string; }`\n  - `ad_group: { id: string; }`\n  - `created_at: string`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'`\n  - `title: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst ad = await client.ads.retrieve('ad_xxxxxxxxxxxxxxx');\n\nconsole.log(ad);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'pause',
    endpoint: '/ads/{id}/pause',
    httpMethod: 'post',
    summary: 'Pause ad',
    description:
      'Pauses an ad.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`',
    stainlessPath: '(resource) ads > (method) pause',
    qualified: 'client.ads.pause',
    params: ['id: string;'],
    response:
      "{ id: string; ad_campaign: { id: string; }; ad_group: { id: string; }; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }",
    markdown:
      "## pause\n\n`client.ads.pause(id: string): { id: string; ad_campaign: object; ad_group: object; created_at: string; platform: ad_campaign_platform; status: external_ad_status; title: string; updated_at: string; }`\n\n**post** `/ads/{id}/pause`\n\nPauses an ad.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; ad_campaign: { id: string; }; ad_group: { id: string; }; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }`\n  An ad belonging to an ad group.\n\n  - `id: string`\n  - `ad_campaign: { id: string; }`\n  - `ad_group: { id: string; }`\n  - `created_at: string`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'`\n  - `title: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst ad = await client.ads.pause('ad_xxxxxxxxxxxxxxx');\n\nconsole.log(ad);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'unpause',
    endpoint: '/ads/{id}/unpause',
    httpMethod: 'post',
    summary: 'Unpause ad',
    description:
      'Resumes a paused ad.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`',
    stainlessPath: '(resource) ads > (method) unpause',
    qualified: 'client.ads.unpause',
    params: ['id: string;'],
    response:
      "{ id: string; ad_campaign: { id: string; }; ad_group: { id: string; }; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }",
    markdown:
      "## unpause\n\n`client.ads.unpause(id: string): { id: string; ad_campaign: object; ad_group: object; created_at: string; platform: ad_campaign_platform; status: external_ad_status; title: string; updated_at: string; }`\n\n**post** `/ads/{id}/unpause`\n\nResumes a paused ad.\n\nRequired permissions:\n - `ad_campaign:update`\n - `ad_campaign:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; ad_campaign: { id: string; }; ad_group: { id: string; }; created_at: string; platform: 'meta' | 'tiktok'; status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'; title: string; updated_at: string; }`\n  An ad belonging to an ad group.\n\n  - `id: string`\n  - `ad_campaign: { id: string; }`\n  - `ad_group: { id: string; }`\n  - `created_at: string`\n  - `platform: 'meta' | 'tiktok'`\n  - `status: 'active' | 'paused' | 'inactive' | 'in_review' | 'rejected' | 'flagged'`\n  - `title: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst ad = await client.ads.unpause('ad_xxxxxxxxxxxxxxx');\n\nconsole.log(ad);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    stainlessPath: '(resource) conversions > (method) create',
    qualified: 'client.conversions.create',
    params: [
      'company_id: string;',
      "event_name: 'lead' | 'submit_application' | 'contact' | 'complete_registration' | 'schedule' | 'custom';",
      'action_source?: string;',
      'context?: { ad_campaign_id?: string; ad_id?: string; ad_set_id?: string; fbclid?: string; fbp?: string; ga?: string; gclid?: string; ig_sid?: string; ip_address?: string; ttclid?: string; ttp?: string; user_agent?: string; utm_campaign?: string; utm_content?: string; utm_id?: string; utm_medium?: string; utm_source?: string; utm_term?: string; };',
      'currency?: string;',
      'custom_name?: string;',
      'event_id?: string;',
      'event_time?: string;',
      ...
      'referrer_url?: string;',
      'url?: string;',
      "user?: { anonymous_id?: string; birthdate?: string; city?: string; country?: string; email?: string; external_id?: string; first_name?: string; gender?: 'male' | 'female'; last_name?: string; member_id?: string; membership_id?: string; name?: string; phone?: string; postal_code?: string; state?: string; user_id?: string; username?: string; };",
      'value?: number;',
    ],
    response: '{ id: string; }',
    markdown:
      "## create\n\n`client.conversions.create(company_id: string, event_name: 'lead' | 'submit_application' | 'contact' | 'complete_registration' | 'schedule' | 'custom', action_source?: string, context?: { ad_campaign_id?: string; ad_id?: string; ad_set_id?: string; fbclid?: string; fbp?: string; ga?: string; gclid?: string; ig_sid?: string; ip_address?: string; ttclid?: string; ttp?: string; user_agent?: string; utm_campaign?: string; utm_content?: string; utm_id?: string; utm_medium?: string; utm_source?: string; utm_term?: string; }, currency?: string, custom_name?: string, event_id?: string, event_time?: string, plan_id?: string, product_id?: string, referrer_url?: string, url?: string, user?: { anonymous_id?: string; birthdate?: string; city?: string; country?: string; email?: string; external_id?: string; first_name?: string; gender?: 'male' | 'female'; last_name?: string; member_id?: string; membership_id?: string; name?: string; phone?: string; postal_code?: string; state?: string; user_id?: string; username?: string; }, value?: number): { id: string; }`\n\n**post** `/conversions`\n\nTrack a conversion or engagement event for a company.\n\nRequired permissions:\n - `event:create`\n\n### Parameters\n\n- `company_id: string`\n  The company to associate with this event.\n\n- `event_name: 'lead' | 'submit_application' | 'contact' | 'complete_registration' | 'schedule' | 'custom'`\n  The type of event.\n\n- `action_source?: string`\n  The channel where an event originated\n\n- `context?: { ad_campaign_id?: string; ad_id?: string; ad_set_id?: string; fbclid?: string; fbp?: string; ga?: string; gclid?: string; ig_sid?: string; ip_address?: string; ttclid?: string; ttp?: string; user_agent?: string; utm_campaign?: string; utm_content?: string; utm_id?: string; utm_medium?: string; utm_source?: string; utm_term?: string; }`\n  Tracking and attribution context.\n  - `ad_campaign_id?: string`\n    Ad campaign ID.\n  - `ad_id?: string`\n    Ad ID.\n  - `ad_set_id?: string`\n    Ad set ID.\n  - `fbclid?: string`\n    Facebook click ID.\n  - `fbp?: string`\n    Facebook browser pixel ID.\n  - `ga?: string`\n    Google Analytics client ID.\n  - `gclid?: string`\n    Google click ID.\n  - `ig_sid?: string`\n    Instagram session ID.\n  - `ip_address?: string`\n    IP address.\n  - `ttclid?: string`\n    TikTok click ID.\n  - `ttp?: string`\n    TikTok pixel ID.\n  - `user_agent?: string`\n    Browser user agent string.\n  - `utm_campaign?: string`\n    UTM campaign parameter.\n  - `utm_content?: string`\n    UTM content parameter.\n  - `utm_id?: string`\n    UTM ID parameter.\n  - `utm_medium?: string`\n    UTM medium parameter.\n  - `utm_source?: string`\n    UTM source parameter.\n  - `utm_term?: string`\n    UTM term parameter.\n\n- `currency?: string`\n  The available currencies on the platform\n\n- `custom_name?: string`\n  Custom event name when event_name is 'custom'.\n\n- `event_id?: string`\n  Client-provided identifier for deduplication. Generated if omitted.\n\n- `event_time?: string`\n  When the event occurred. Defaults to now.\n\n- `plan_id?: string`\n  The plan associated with the event.\n\n- `product_id?: string`\n  The product associated with the event.\n\n- `referrer_url?: string`\n  The referring URL.\n\n- `url?: string`\n  The URL where the event occurred.\n\n- `user?: { anonymous_id?: string; birthdate?: string; city?: string; country?: string; email?: string; external_id?: string; first_name?: string; gender?: 'male' | 'female'; last_name?: string; member_id?: string; membership_id?: string; name?: string; phone?: string; postal_code?: string; state?: string; user_id?: string; username?: string; }`\n  User identity and profile data.\n  - `anonymous_id?: string`\n    An anonymous identifier for the user.\n  - `birthdate?: string`\n    Date of birth (YYYY-MM-DD).\n  - `city?: string`\n    City.\n  - `country?: string`\n    Country.\n  - `email?: string`\n    Email address.\n  - `external_id?: string`\n    An external identifier for the user.\n  - `first_name?: string`\n    First name.\n  - `gender?: 'male' | 'female'`\n    Gender\n  - `last_name?: string`\n    Last name.\n  - `member_id?: string`\n    The Whop member ID.\n  - `membership_id?: string`\n    The Whop membership ID.\n  - `name?: string`\n    Full display name.\n  - `phone?: string`\n    Phone number.\n  - `postal_code?: string`\n    Postal code.\n  - `state?: string`\n    State or region.\n  - `user_id?: string`\n    The Whop user ID.\n  - `username?: string`\n    Username.\n\n- `value?: number`\n  Monetary value associated with the event.\n\n### Returns\n\n- `{ id: string; }`\n  A tracked conversion event\n\n  - `id: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst conversion = await client.conversions.create({ company_id: 'biz_xxxxxxxxxxxxxx', event_name: 'lead' });\n\nconsole.log(conversion);\n```",
    perLanguage: {
      typescript: {
