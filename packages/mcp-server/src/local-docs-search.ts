...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; payment_method_type: string; typename: 'BasePaymentMethod'; } | { id: string; card: { brand: string; exp_month: number; exp_year: number; last4: string; three_ds_verified: boolean; }; created_at: string; has_payer_document: boolean; payment_method_type: string; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; payment_method_type: string; typename: 'UsBankAccountPaymentMethod'; us_bank_account: { account_type: string; bank_name: string; last4: string; }; } | { id: string; cashapp: { buyer_id: string; cashtag: string; }; created_at: string; payment_method_type: string; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; ideal: { bank: string; bic: string; }; payment_method_type: string; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; payment_method_type: string; sepa_debit: { bank_code: string; branch_code: string; country: string; last4: string; }; typename: 'SepaDebitPaymentMethod'; } | { id: string; created_at: string; payment_method_type: string; platform_balance: { balances: { amount: number; currency: currency; }[]; spendable: boolean; }; typename: 'PlatformBalancePaymentMethod'; }",
    markdown:
      "## list\n\n`client.paymentMethods.list(after?: string, before?: string, company_id?: string, created_after?: string, created_before?: string, direction?: 'asc' | 'desc', first?: number, future_usage?: 'off_session' | 'on_session', last?: number, member_id?: string): { id: string; created_at: string; payment_method_type: payment_method_types; typename: 'BasePaymentMethod'; } | { id: string; card: object; created_at: string; has_payer_document: boolean; payment_method_type: payment_method_types; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; payment_method_type: payment_method_types; typename: 'UsBankAccountPaymentMethod'; us_bank_account: object; } | { id: string; cashapp: object; created_at: string; payment_method_type: payment_method_types; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; ideal: object; payment_method_type: payment_method_types; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; payment_method_type: payment_method_types; sepa_debit: object; typename: 'SepaDebitPaymentMethod'; } | { id: string; created_at: string; payment_method_type: payment_method_types; platform_balance: object; typename: 'PlatformBalancePaymentMethod'; }`\n\n**get** `/payment_methods`\n\nReturns a paginated list of payment methods for a member or company, or for the authenticated user when neither is given, with optional filtering by creation date. A payment method is a stored representation of how a customer intends to pay, such as a card, bank account, or digital wallet.\n\nRequired permissions:\n - `member:payment_methods:read`\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `company_id?: string`\n  The unique identifier of the company. Provide either this or member_id, not both. Omit both to address your own saved payment methods.\n\n- `created_after?: string`\n  Only return payment methods created after this timestamp.\n\n- `created_before?: string`\n  Only return payment methods created before this timestamp.\n\n- `direction?: 'asc' | 'desc'`\n  The direction of the sort.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `future_usage?: 'off_session' | 'on_session'`\n  How a payment method will be charged after the buyer leaves — the same vocabulary as a confirmation token's setup_future_usage.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `member_id?: string`\n  The unique identifier of the member to list payment methods for. Omit this and company_id to list your own saved payment methods.\n\n### Returns\n\n- `{ id: string; created_at: string; payment_method_type: string; typename: 'BasePaymentMethod'; } | { id: string; card: { brand: string; exp_month: number; exp_year: number; last4: string; three_ds_verified: boolean; }; created_at: string; has_payer_document: boolean; payment_method_type: string; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; payment_method_type: string; typename: 'UsBankAccountPaymentMethod'; us_bank_account: { account_type: string; bank_name: string; last4: string; }; } | { id: string; cashapp: { buyer_id: string; cashtag: string; }; created_at: string; payment_method_type: string; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; ideal: { bank: string; bic: string; }; payment_method_type: string; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; payment_method_type: string; sepa_debit: { bank_code: string; branch_code: string; country: string; last4: string; }; typename: 'SepaDebitPaymentMethod'; } | { id: string; created_at: string; payment_method_type: string; platform_balance: { balances: { amount: number; currency: currency; }[]; spendable: boolean; }; typename: 'PlatformBalancePaymentMethod'; }`\n  A saved payment method with no type-specific details available.\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const paymentMethodListResponse of client.paymentMethods.list()) {\n  console.log(paymentMethodListResponse);\n}\n```",
    perLanguage: {
      typescript: {
