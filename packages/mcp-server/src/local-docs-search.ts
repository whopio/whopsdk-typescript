...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      '{ id: string; amount: number; company: { id: string; title: string; }; created_at: string; currency: string; editable: boolean; needs_response_by: string; payment: { id: string; }; plan: { id: string; }; product: { id: string; title: string; }; reason: string; reason_code: string; status: string; visa_rdr: boolean; }',
    markdown:
