...
const EMBEDDED_METHODS: MethodEntry[] = [
  ...
  },
  {
    ...
    response:
      "{ id: string; api_key: { id: string; token: string; created_at: string; }; app_type: 'b2b_app' | 'b2c_app' | 'company_app' | 'component' | 'website'; base_url: string; company: { id: string; title: string; }; creator: { id: string; name: string; username: string; }; dashboard_path: string; default_api_key: { id: string; name: string; obfuscated_secret_key: string; secret_key: string; }; description: string; discover_path: string; domain_id: string; experience_path: string; hosted_url: string; icon: { url: string; }; marketplace_status: 'not_available' | 'pending_review' | 'live_marketplace'; name: string; oauth_client_type: 'public' | 'confidential'; openapi_path: string; origin: string; product_id: string; production_web_build: { id: string; checksum: string; file_url: string; source_url: string; status: app_build_statuses; }; redirect_uris: string[]; requested_permissions: { is_required: boolean; justification: string; permission_action: object; }[]; route: string; secrets: object; skills_path: string; stats: { dau: number; mau: number; time_spent_last24_hours: number; wau: number; }; status: 'live' | 'unlisted' | 'hidden'; verified: boolean; }",
    markdown:
      "## create\n\n`client.apps.create(company_id: string, name: string, base_url?: string, icon?: { id: string; }, redirect_uris?: string[], route?: string): { id: string; api_key: object; app_type: app_type; base_url: string; company: object; creator: object; dashboard_path: string; default_api_key: object; description: string; discover_path: string; domain_id: string; experience_path: string; hosted_url: string; icon: object; marketplace_status: 'not_available' | 'pending_review' | 'live_marketplace'; name: string; oauth_client_type: 'public' | 'confidential'; openapi_path: string; origin: string; product_id: string; production_web_build: object; redirect_uris: string[]; requested_permissions: object[]; route: string; secrets: object; skills_path: string; stats: object; status: app_statuses; verified: boolean; }`\n\n**post** `/apps`\n\nRegister a new app on the Whop developer platform. Apps provide custom experiences that can be added to products.\n\nRequired permissions:\n - `developer:create_app`\n - `developer:manage_api_key`\n - `developer:basic:read`\n - `developer:update_app`\n\n### Parameters\n\n- `company_id: string`\n  The unique identifier of the company to create the app for, starting with 'biz_'.\n\n- `name: string`\n  The display name for the app, shown to users on the app store and product pages.\n\n- `base_url?: string`\n  The base production URL where the app is hosted, such as 'https://myapp.example.com'.\n\n- `icon?: { id: string; }`\n  The icon image for the app in PNG, JPEG, or GIF format.\n  - `id: string`\n    The ID of an existing file object.\n\n- `redirect_uris?: string[]`\n  The whitelisted OAuth callback URLs that users are redirected to after authorizing the app.\n\n- `route?: string`\n  The unique subdomain route where the app's hosted web builds are served, such as 'myapp' for myapp.whop.site.\n\n### Returns\n\n- `{ id: string; api_key: { id: string; token: string; created_at: string; }; app_type: 'b2b_app' | 'b2c_app' | 'company_app' | 'component' | 'website'; base_url: string; company: { id: string; title: string; }; creator: { id: string; name: string; username: string; }; dashboard_path: string; default_api_key: { id: string; name: string; obfuscated_secret_key: string; secret_key: string; }; description: string; discover_path: string; domain_id: string; experience_path: string; hosted_url: string; icon: { url: string; }; marketplace_status: 'not_available' | 'pending_review' | 'live_marketplace'; name: string; oauth_client_type: 'public' | 'confidential'; openapi_path: string; origin: string; product_id: string; production_web_build: { id: string; checksum: string; file_url: string; source_url: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; }; redirect_uris: string[]; requested_permissions: { is_required: boolean; justification: string; permission_action: { action: string; name: string; }; }[]; route: string; secrets: object; skills_path: string; stats: { dau: number; mau: number; time_spent_last24_hours: number; wau: number; }; status: 'live' | 'unlisted' | 'hidden'; verified: boolean; }`\n  An app is an integration built on Whop. Apps can serve consumers as experiences within products, or serve companies as business tools.\n\n  - `id: string`\n  - `api_key: { id: string; token: string; created_at: string; }`\n  - `app_type: 'b2b_app' | 'b2c_app' | 'company_app' | 'component' | 'website'`\n  - `base_url: string`\n  - `company: { id: string; title: string; }`\n  - `creator: { id: string; name: string; username: string; }`\n  - `dashboard_path: string`\n  - `default_api_key: { id: string; name: string; obfuscated_secret_key: string; secret_key: string; }`\n  - `description: string`\n  - `discover_path: string`\n  - `domain_id: string`\n  - `experience_path: string`\n  - `hosted_url: string`\n  - `icon: { url: string; }`\n  - `marketplace_status: 'not_available' | 'pending_review' | 'live_marketplace'`\n  - `name: string`\n  - `oauth_client_type: 'public' | 'confidential'`\n  - `openapi_path: string`\n  - `origin: string`\n  - `product_id: string`\n  - `production_web_build: { id: string; checksum: string; file_url: string; source_url: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; }`\n  - `redirect_uris: string[]`\n  - `requested_permissions: { is_required: boolean; justification: string; permission_action: { action: string; name: string; }; }[]`\n  - `route: string`\n  - `secrets: object`\n  - `skills_path: string`\n  - `stats: { dau: number; mau: number; time_spent_last24_hours: number; wau: number; }`\n  - `status: 'live' | 'unlisted' | 'hidden'`\n  - `verified: boolean`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst app = await client.apps.create({ company_id: 'biz_xxxxxxxxxxxxxx', name: 'name' });\n\nconsole.log(app);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; automatically_finalizes_at: string; charge_buyer_fee: boolean; collection_method: 'send_invoice' | 'charge_automatically'; company: { id: string; }; created_at: string; current_plan: { id: string; currency: string; description: string; formatted_price: string; }; customer_name: string; due_date: string; email_address: string; fetch_invoice_token: string; line_items: { label: string; position: number; quantity: number; total: number; unit_price: number; }[]; mailing_address: { city: string; country: string; line1: string; line2: string; name: string; phone: string; postal_code: string; state: string; }; member: { id: string; }; number: string; pay_online_url: string; payment: { id: string; }; payment_processing: boolean; product: { id: string; title: string; }; status: 'draft' | 'open' | 'paid' | 'past_due' | 'uncollectible' | 'void'; subscription_billing_anchor_at: string; updated_at: string; user: { id: string; email: string; name: string; username: string; }; }",
    markdown:
      "## retrieve\n\n`client.invoices.retrieve(id: string): { id: string; automatically_finalizes_at: string; charge_buyer_fee: boolean; collection_method: collection_method; company: object; created_at: string; current_plan: object; customer_name: string; due_date: string; email_address: string; fetch_invoice_token: string; line_items: object[]; mailing_address: object; member: object; number: string; pay_online_url: string; payment: object; payment_processing: boolean; product: object; status: invoice_status; subscription_billing_anchor_at: string; updated_at: string; user: object; }`\n\n**get** `/invoices/{id}`\n\nRetrieves the details of an existing invoice.\n\nRequired permissions:\n - `invoice:basic:read`\n - `member:email:read`\n - `member:basic:read`\n - `payment:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; automatically_finalizes_at: string; charge_buyer_fee: boolean; collection_method: 'send_invoice' | 'charge_automatically'; company: { id: string; }; created_at: string; current_plan: { id: string; currency: string; description: string; formatted_price: string; }; customer_name: string; due_date: string; email_address: string; fetch_invoice_token: string; line_items: { label: string; position: number; quantity: number; total: number; unit_price: number; }[]; mailing_address: { city: string; country: string; line1: string; line2: string; name: string; phone: string; postal_code: string; state: string; }; member: { id: string; }; number: string; pay_online_url: string; payment: { id: string; }; payment_processing: boolean; product: { id: string; title: string; }; status: 'draft' | 'open' | 'paid' | 'past_due' | 'uncollectible' | 'void'; subscription_billing_anchor_at: string; updated_at: string; user: { id: string; email: string; name: string; username: string; }; }`\n  An invoice represents an itemized bill sent by a company to a customer for a specific product and plan, tracking the amount owed, due date, and payment status.\n\n  - `id: string`\n  - `automatically_finalizes_at: string`\n  - `charge_buyer_fee: boolean`\n  - `collection_method: 'send_invoice' | 'charge_automatically'`\n  - `company: { id: string; }`\n  - `created_at: string`\n  - `current_plan: { id: string; currency: string; description: string; formatted_price: string; }`\n  - `customer_name: string`\n  - `due_date: string`\n  - `email_address: string`\n  - `fetch_invoice_token: string`\n  - `line_items: { label: string; position: number; quantity: number; total: number; unit_price: number; }[]`\n  - `mailing_address: { city: string; country: string; line1: string; line2: string; name: string; phone: string; postal_code: string; state: string; }`\n  - `member: { id: string; }`\n  - `number: string`\n  - `pay_online_url: string`\n  - `payment: { id: string; }`\n  - `payment_processing: boolean`\n  - `product: { id: string; title: string; }`\n  - `status: 'draft' | 'open' | 'paid' | 'past_due' | 'uncollectible' | 'void'`\n  - `subscription_billing_anchor_at: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst invoice = await client.invoices.retrieve('inv_xxxxxxxxxxxxxx');\n\nconsole.log(invoice);\n```",
    perLanguage: {
      typescript: {
  ...
  {
    name: 'create_api_key',
    endpoint: '/companies/{parent_company_id}/api_keys',
    httpMethod: 'post',
  ...
  },
  {
    ...
    response:
      "{ id: string; api_version: 'v1' | 'v2' | 'v5'; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; url: string; webhook_secret: string; }",
    markdown:
      "## list\n\n`client.webhooks.list(company_id: string, after?: string, app_id?: string, before?: string, first?: number, last?: number): { id: string; api_version: api_version; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: webhook_event[]; resource_id: string; url: string; webhook_secret: string; }`\n\n**get** `/webhooks`\n\nReturns a paginated list of webhook endpoints configured for a company, ordered by most recently created.\n\nRequired permissions:\n - `developer:manage_webhook`\n\n### Parameters\n\n- `company_id: string`\n  The unique identifier of the company to list webhooks for.\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `app_id?: string`\n  Only return webhooks attached to this app. Omit to list the company's own webhooks.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n### Returns\n\n- `{ id: string; api_version: 'v1' | 'v2' | 'v5'; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; url: string; webhook_secret: string; }`\n  A webhook endpoint that receives event notifications for a company via HTTP POST.\n\n  - `id: string`\n  - `api_version: 'v1' | 'v2' | 'v5'`\n  - `api_version_date: string`\n  - `child_resource_events: boolean`\n  - `created_at: string`\n  - `enabled: boolean`\n  - `events: string[]`\n  - `resource_id: string`\n  - `url: string`\n  - `webhook_secret: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const webhookListResponse of client.webhooks.list({ company_id: 'biz_xxxxxxxxxxxxxx' })) {\n  console.log(webhookListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; api_version: 'v1' | 'v2' | 'v5'; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; testable_events: string[]; url: string; webhook_secret: string; }",
    markdown:
      "## retrieve\n\n`client.webhooks.retrieve(id: string): { id: string; api_version: api_version; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: webhook_event[]; resource_id: string; testable_events: webhook_event[]; url: string; webhook_secret: string; }`\n\n**get** `/webhooks/{id}`\n\nRetrieves the details of an existing webhook.\n\nRequired permissions:\n - `developer:manage_webhook`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; api_version: 'v1' | 'v2' | 'v5'; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; testable_events: string[]; url: string; webhook_secret: string; }`\n  A webhook endpoint that receives event notifications for a company via HTTP POST.\n\n  - `id: string`\n  - `api_version: 'v1' | 'v2' | 'v5'`\n  - `api_version_date: string`\n  - `child_resource_events: boolean`\n  - `created_at: string`\n  - `enabled: boolean`\n  - `events: string[]`\n  - `resource_id: string`\n  - `testable_events: string[]`\n  - `url: string`\n  - `webhook_secret: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst webhook = await client.webhooks.retrieve('hook_xxxxxxxxxxxxx');\n\nconsole.log(webhook);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; api_version: 'v1' | 'v2' | 'v5'; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; testable_events: string[]; url: string; webhook_secret: string; }",
    markdown:
      "## update\n\n`client.webhooks.update(id: string, api_version?: 'v1' | 'v2' | 'v5', api_version_date?: string, child_resource_events?: boolean, enabled?: boolean, events?: string[], url?: string): { id: string; api_version: api_version; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: webhook_event[]; resource_id: string; testable_events: webhook_event[]; url: string; webhook_secret: string; }`\n\n**patch** `/webhooks/{id}`\n\nUpdates a webhook\n\nRequired permissions:\n - `developer:manage_webhook`\n\n### Parameters\n\n- `id: string`\n\n- `api_version?: 'v1' | 'v2' | 'v5'`\n  The different API versions\n\n- `api_version_date?: string`\n  The dated API version (Api-Version-Date) to pin this webhook's payloads to: events serialize exactly like a REST read at this version (the native serializer where the resource has one). Only applies to v1 webhooks. Pass null to unpin, returning to the legacy payload shape.\n\n- `child_resource_events?: boolean`\n  Whether or not to send events for child resources.\n\n- `enabled?: boolean`\n  Whether or not the webhook is enabled.\n\n- `events?: string[]`\n  The events to send the webhook for.\n\n- `url?: string`\n  The URL to send the webhook to.\n\n### Returns\n\n- `{ id: string; api_version: 'v1' | 'v2' | 'v5'; api_version_date: string; child_resource_events: boolean; created_at: string; enabled: boolean; events: string[]; resource_id: string; testable_events: string[]; url: string; webhook_secret: string; }`\n  A webhook endpoint that receives event notifications for a company via HTTP POST.\n\n  - `id: string`\n  - `api_version: 'v1' | 'v2' | 'v5'`\n  - `api_version_date: string`\n  - `child_resource_events: boolean`\n  - `created_at: string`\n  - `enabled: boolean`\n  - `events: string[]`\n  - `resource_id: string`\n  - `testable_events: string[]`\n  - `url: string`\n  - `webhook_secret: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst webhook = await client.webhooks.update('hook_xxxxxxxxxxxxx');\n\nconsole.log(webhook);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## list\n\n`client.memberships.list(after?: string, before?: string, cancel_options?: string[], cancelation_status?: 'won_back' | 'left' | 'canceling', company_id?: string, created_after?: string, created_before?: string, direction?: 'asc' | 'desc', first?: number, has_cancelation_reason?: boolean, include_text_only_cancelation_reasons?: boolean, last?: number, order?: 'id' | 'created_at' | 'status' | 'canceled_at' | 'date_joined' | 'total_spend', plan_ids?: string[], product_ids?: string[], promo_code_ids?: string[], statuses?: string[], user_ids?: string[]): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**get** `/memberships`\n\nReturns a paginated list of memberships, with optional filtering by product, plan, status, and user.\n\nRequired permissions:\n - `member:basic:read`\n - `member:email:read`\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `cancel_options?: string[]`\n  Filter to only memberships matching these cancellation reasons.\n\n- `cancelation_status?: 'won_back' | 'left' | 'canceling'`\n  Filter memberships by whether the customer is canceling, left, or was won back.\n\n- `company_id?: string`\n  The unique identifier of the company to list memberships for. Required when using an API key.\n\n- `created_after?: string`\n  Only return memberships created after this timestamp.\n\n- `created_before?: string`\n  Only return memberships created before this timestamp.\n\n- `direction?: 'asc' | 'desc'`\n  The sort direction for results. Defaults to descending.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `has_cancelation_reason?: boolean`\n  Filter memberships by whether they have a structured or free-text cancellation reason.\n\n- `include_text_only_cancelation_reasons?: boolean`\n  When filtering by the other cancellation option, also include memberships that only have a free-text cancellation reason.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `order?: 'id' | 'created_at' | 'status' | 'canceled_at' | 'date_joined' | 'total_spend'`\n  The field to sort results by. Null uses the default sort order.\n\n- `plan_ids?: string[]`\n  Filter to only memberships belonging to these plan identifiers.\n\n- `product_ids?: string[]`\n  Filter to only memberships belonging to these product identifiers.\n\n- `promo_code_ids?: string[]`\n  Filter to only memberships that used these promo code identifiers.\n\n- `statuses?: string[]`\n  Filter to only memberships matching these statuses.\n\n- `user_ids?: string[]`\n  Filter to only memberships belonging to these user identifiers.\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const membershipListResponse of client.memberships.list()) {\n  console.log(membershipListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['id: string;'],
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## retrieve\n\n`client.memberships.retrieve(id: string): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; custom_field_responses: object[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**get** `/memberships/{id}`\n\nRetrieves the details of an existing membership.\n\nRequired permissions:\n - `member:basic:read`\n - `member:email:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `custom_field_responses: { id: string; answer: string; question: string; }[]`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst membership = await client.memberships.retrieve('mem_xxxxxxxxxxxxxx');\n\nconsole.log(membership);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## update\n\n`client.memberships.update(id: string, metadata?: object): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; custom_field_responses: object[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**patch** `/memberships/{id}`\n\nUpdate a membership's metadata or other mutable properties.\n\nRequired permissions:\n - `member:manage`\n - `member:email:read`\n - `member:basic:read`\n\n### Parameters\n\n- `id: string`\n\n- `metadata?: object`\n  A JSON object of key-value pairs to store on the membership. Replaces any existing metadata.\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `custom_field_responses: { id: string; answer: string; question: string; }[]`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst membership = await client.memberships.update('mem_xxxxxxxxxxxxxx');\n\nconsole.log(membership);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['id: string;', 'resumes_at?: string;', 'void_payments?: boolean;'],
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## pause\n\n`client.memberships.pause(id: string, resumes_at?: string, void_payments?: boolean): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; custom_field_responses: object[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**post** `/memberships/{id}/pause`\n\nPause a membership's recurring payments. The customer retains access but will not be charged until the membership is resumed.\n\nRequired permissions:\n - `member:manage`\n - `member:email:read`\n - `member:basic:read`\n\n### Parameters\n\n- `id: string`\n\n- `resumes_at?: string`\n  When the membership should automatically resume payment collection. If not provided, the membership stays paused until manually resumed.\n\n- `void_payments?: boolean`\n  Whether to void any outstanding past-due payments on this membership, preventing future collection attempts.\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `custom_field_responses: { id: string; answer: string; question: string; }[]`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst membership = await client.memberships.pause('mem_xxxxxxxxxxxxxx');\n\nconsole.log(membership);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## resume\n\n`client.memberships.resume(id: string): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; custom_field_responses: object[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**post** `/memberships/{id}/resume`\n\nResume a previously paused membership's recurring payments. Billing resumes on the next cycle.\n\nRequired permissions:\n - `member:manage`\n - `member:email:read`\n - `member:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `custom_field_responses: { id: string; answer: string; question: string; }[]`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst membership = await client.memberships.resume('mem_xxxxxxxxxxxxxx');\n\nconsole.log(membership);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## uncancel\n\n`client.memberships.uncancel(id: string): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; custom_field_responses: object[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**post** `/memberships/{id}/uncancel`\n\nReverse a pending cancellation for a membership that was scheduled to cancel at period end.\n\nRequired permissions:\n - `member:manage`\n - `member:email:read`\n - `member:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `custom_field_responses: { id: string; answer: string; question: string; }[]`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst membership = await client.memberships.uncancel('mem_xxxxxxxxxxxxxx');\n\nconsole.log(membership);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }",
    markdown:
      "## add_free_days\n\n`client.memberships.addFreeDays(id: string, free_days: number): { id: string; cancel_at_period_end: boolean; cancel_option: cancel_options; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; custom_field_responses: object[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: object; metadata: object; payment_collection_paused: boolean; plan: object; product: object; promo_code: object; renewal_period_end: string; renewal_period_start: string; status: membership_status; updated_at: string; user: object; }`\n\n**post** `/memberships/{id}/add_free_days`\n\nAdd free days to extend a membership's current billing period, expiration date, or Stripe trial.\n\nRequired permissions:\n - `member:manage`\n - `member:email:read`\n - `member:basic:read`\n\n### Parameters\n\n- `id: string`\n\n- `free_days: number`\n  The number of free days to add (1-1095). Extends the billing period, expiration date, or Stripe trial depending on plan type.\n\n### Returns\n\n- `{ id: string; cancel_at_period_end: boolean; cancel_option: string; cancelation_status: 'won_back' | 'left' | 'canceling'; canceled_at: string; cancellation_reason: string; checkout_configuration_id: string; company: { id: string; title: string; }; created_at: string; currency: string; custom_field_responses: { id: string; answer: string; question: string; }[]; formatted_renewal_price: string; initial_price_paid: string; joined_at: string; license_key: string; manage_url: string; member: { id: string; }; metadata: object; payment_collection_paused: boolean; plan: { id: string; metadata: object; }; product: { id: string; metadata: object; title: string; }; promo_code: { id: string; }; renewal_period_end: string; renewal_period_start: string; status: string; updated_at: string; user: { id: string; email: string; name: string; profile_pic: string; username: string; }; }`\n  A membership represents an active relationship between a user and a product. It tracks the user's access, billing status, and renewal schedule.\n\n  - `id: string`\n  - `cancel_at_period_end: boolean`\n  - `cancel_option: string`\n  - `cancelation_status: 'won_back' | 'left' | 'canceling'`\n  - `canceled_at: string`\n  - `cancellation_reason: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `custom_field_responses: { id: string; answer: string; question: string; }[]`\n  - `formatted_renewal_price: string`\n  - `initial_price_paid: string`\n  - `joined_at: string`\n  - `license_key: string`\n  - `manage_url: string`\n  - `member: { id: string; }`\n  - `metadata: object`\n  - `payment_collection_paused: boolean`\n  - `plan: { id: string; metadata: object; }`\n  - `product: { id: string; metadata: object; title: string; }`\n  - `promo_code: { id: string; }`\n  - `renewal_period_end: string`\n  - `renewal_period_start: string`\n  - `status: string`\n  - `updated_at: string`\n  - `user: { id: string; email: string; name: string; profile_pic: string; username: string; }`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst membership = await client.memberships.addFreeDays('mem_xxxxxxxxxxxxxx', { free_days: 42 });\n\nconsole.log(membership);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: 'ios' | 'android' | 'web'; review_message: string; source_url: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]; }",
    markdown:
      "## retrieve\n\n`client.appBuilds.retrieve(id: string): { id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: app_build_platforms; review_message: string; source_url: string; status: app_build_statuses; supported_app_view_types: app_view_type[]; }`\n\n**get** `/app_builds/{id}`\n\nRetrieves the details of an existing app build.\n\nRequired permissions:\n - `developer:manage_builds`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: 'ios' | 'android' | 'web'; review_message: string; source_url: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]; }`\n  A versioned build artifact for a Whop React Native App, submitted for review and deployment to a specific platform.\n\n  - `id: string`\n  - `checksum: string`\n  - `created_at: string`\n  - `file_url: string`\n  - `is_production: boolean`\n  - `platform: 'ios' | 'android' | 'web'`\n  - `review_message: string`\n  - `source_url: string`\n  - `status: 'draft' | 'pending' | 'approved' | 'rejected'`\n  - `supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst appBuild = await client.appBuilds.retrieve('apbu_xxxxxxxxxxxxx');\n\nconsole.log(appBuild);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: 'ios' | 'android' | 'web'; review_message: string; source_url: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]; }",
    markdown:
      "## promote\n\n`client.appBuilds.promote(id: string): { id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: app_build_platforms; review_message: string; source_url: string; status: app_build_statuses; supported_app_view_types: app_view_type[]; }`\n\n**post** `/app_builds/{id}/promote`\n\nPromote an approved or draft app build to production so it becomes the active version served to users.\n\nRequired permissions:\n - `developer:manage_builds`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; checksum: string; created_at: string; file_url: string; is_production: boolean; platform: 'ios' | 'android' | 'web'; review_message: string; source_url: string; status: 'draft' | 'pending' | 'approved' | 'rejected'; supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]; }`\n  A versioned build artifact for a Whop React Native App, submitted for review and deployment to a specific platform.\n\n  - `id: string`\n  - `checksum: string`\n  - `created_at: string`\n  - `file_url: string`\n  - `is_production: boolean`\n  - `platform: 'ios' | 'android' | 'web'`\n  - `review_message: string`\n  - `source_url: string`\n  - `status: 'draft' | 'pending' | 'approved' | 'rejected'`\n  - `supported_app_view_types: 'hub' | 'discover' | 'dash' | 'dashboard' | 'analytics' | 'skills' | 'openapi'[]`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst appBuild = await client.appBuilds.promote('apbu_xxxxxxxxxxxxx');\n\nconsole.log(appBuild);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ id: string; created_at: string; delivery_estimate: string; payment: { id: string; }; service: string; status: string; substatus: string; tracking_code: string; updated_at: string; }',
    markdown:
      "## list\n\n`client.shipments.list(after?: string, before?: string, company_id?: string, first?: number, last?: number, payment_id?: string, user_id?: string): { id: string; created_at: string; delivery_estimate: string; payment: object; service: string; status: shipment_status; substatus: shipment_substatus; tracking_code: string; updated_at: string; }`\n\n**get** `/shipments`\n\nReturns a paginated list of shipments, with optional filtering by payment, company, or user.\n\nRequired permissions:\n - `shipment:basic:read`\n - `payment:basic:read`\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `company_id?: string`\n  Filter shipments to only those belonging to this company.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `payment_id?: string`\n  Filter shipments to only those associated with this specific payment.\n\n- `user_id?: string`\n  Filter shipments to only those for this specific user.\n\n### Returns\n\n- `{ id: string; created_at: string; delivery_estimate: string; payment: { id: string; }; service: string; status: string; substatus: string; tracking_code: string; updated_at: string; }`\n  A physical shipment associated with a payment, including carrier details and tracking information.\n\n  - `id: string`\n  - `created_at: string`\n  - `delivery_estimate: string`\n  - `payment: { id: string; }`\n  - `service: string`\n  - `status: string`\n  - `substatus: string`\n  - `tracking_code: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const shipmentListResponse of client.shipments.list()) {\n  console.log(shipmentListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      '{ id: string; created_at: string; delivery_estimate: string; payment: { id: string; }; service: string; status: string; substatus: string; tracking_code: string; updated_at: string; }',
    markdown:
      "## retrieve\n\n`client.shipments.retrieve(id: string): { id: string; created_at: string; delivery_estimate: string; payment: object; service: string; status: shipment_status; substatus: shipment_substatus; tracking_code: string; updated_at: string; }`\n\n**get** `/shipments/{id}`\n\nRetrieves the details of an existing shipment.\n\nRequired permissions:\n - `shipment:basic:read`\n - `payment:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; created_at: string; delivery_estimate: string; payment: { id: string; }; service: string; status: string; substatus: string; tracking_code: string; updated_at: string; }`\n  A physical shipment associated with a payment, including carrier details and tracking information.\n\n  - `id: string`\n  - `created_at: string`\n  - `delivery_estimate: string`\n  - `payment: { id: string; }`\n  - `service: string`\n  - `status: string`\n  - `substatus: string`\n  - `tracking_code: string`\n  - `updated_at: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst shipment = await client.shipments.retrieve('ship_xxxxxxxxxxxxx');\n\nconsole.log(shipment);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; affiliate_code: string; company_id: string; currency: string; metadata: object; mode: 'payment' | 'setup'; payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }; plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; purchase_url: string; redirect_url: string; }",
    markdown:
      "## list\n\n`client.checkoutConfigurations.list(company_id: string, after?: string, before?: string, created_after?: string, created_before?: string, direction?: 'asc' | 'desc', first?: number, last?: number, plan_id?: string): { id: string; affiliate_code: string; company_id: string; currency: currency; metadata: object; mode: checkout_modes; payment_method_configuration: object; plan: object; purchase_url: string; redirect_url: string; }`\n\n**get** `/checkout_configurations`\n\nReturns a paginated list of checkout configurations for a company, with optional filtering by plan and creation date.\n\nRequired permissions:\n - `checkout_configuration:basic:read`\n\n### Parameters\n\n- `company_id: string`\n  The unique identifier of the company to list checkout configurations for.\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `created_after?: string`\n  Only return checkout configurations created after this timestamp.\n\n- `created_before?: string`\n  Only return checkout configurations created before this timestamp.\n\n- `direction?: 'asc' | 'desc'`\n  The sort direction for ordering results, either ascending or descending.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `plan_id?: string`\n  Filter checkout configurations to only those associated with this plan identifier.\n\n### Returns\n\n- `{ id: string; affiliate_code: string; company_id: string; currency: string; metadata: object; mode: 'payment' | 'setup'; payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }; plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; purchase_url: string; redirect_url: string; }`\n  A checkout configuration is a reusable configuration for a checkout, including the plan, affiliate, and custom metadata. Payments and memberships created from a checkout session inherit its metadata.\n\n  - `id: string`\n  - `affiliate_code: string`\n  - `company_id: string`\n  - `currency: string`\n  - `metadata: object`\n  - `mode: 'payment' | 'setup'`\n  - `payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }`\n  - `plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }`\n  - `purchase_url: string`\n  - `redirect_url: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const checkoutConfigurationListResponse of client.checkoutConfigurations.list({ company_id: 'biz_xxxxxxxxxxxxxx' })) {\n  console.log(checkoutConfigurationListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      "{ plan: { company_id: string; currency: string; adaptive_pricing_enabled?: boolean; application_fee_amount?: number; billing_period?: number; custom_fields?: { field_type: 'text'; name: string; id?: string; order?: number; placeholder?: string; required?: boolean; }[]; description?: string; expiration_days?: number; force_create_new_plan?: boolean; image?: { id: string; }; initial_price?: number; internal_notes?: string; override_tax_type?: 'inclusive' | 'exclusive' | 'unspecified'; payment_method_configuration?: { disabled: string[]; enabled: string[]; include_platform_defaults?: boolean; }; plan_type?: 'renewal' | 'one_time'; product?: { external_identifier: string; title: string; collect_shipping_address?: boolean; custom_statement_descriptor?: string; description?: string; global_affiliate_percentage?: number; global_affiliate_status?: 'enabled' | 'disabled'; headline?: string; product_tax_code_id?: string; redirect_purchase_url?: string; route?: string; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; product_id?: string; release_method?: 'buy_now' | 'waitlist'; renewal_price?: number; split_pay_required_payments?: number; stock?: number; title?: string; trial_period_days?: number; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; affiliate_code?: string; checkout_styling?: { background_color?: string; border_style?: 'rounded' | 'pill' | 'rectangular'; button_color?: string; font_family?: 'system' | 'roboto' | 'open_sans'; }; currency?: string; metadata?: object; mode?: 'payment'; payment_method_configuration?: { disabled: string[]; enabled: string[]; include_platform_defaults?: boolean; }; redirect_url?: string; } | { plan_id: string; affiliate_code?: string; checkout_styling?: { background_color?: string; border_style?: 'rounded' | 'pill' | 'rectangular'; button_color?: string; font_family?: 'system' | 'roboto' | 'open_sans'; }; currency?: string; metadata?: object; mode?: 'payment'; payment_method_configuration?: { disabled: string[]; enabled: string[]; include_platform_defaults?: boolean; }; redirect_url?: string; } | { company_id: string; mode: 'setup'; checkout_styling?: { background_color?: string; border_style?: 'rounded' | 'pill' | 'rectangular'; button_color?: string; font_family?: 'system' | 'roboto' | 'open_sans'; }; currency?: string; metadata?: object; payment_method_configuration?: { disabled: string[]; enabled: string[]; include_platform_defaults?: boolean; }; redirect_url?: string; three_ds_level?: 'mandate_challenge' | 'frictionless'; };",
    ],
    response:
      "{ id: string; affiliate_code: string; company_id: string; currency: string; metadata: object; mode: 'payment' | 'setup'; payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }; plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; purchase_url: string; redirect_url: string; }",
    perLanguage: {
  ...
  },
  {
    ...
    response:
      "{ id: string; affiliate_code: string; company_id: string; currency: string; metadata: object; mode: 'payment' | 'setup'; payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }; plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; purchase_url: string; redirect_url: string; }",
    markdown:
      "## retrieve\n\n`client.checkoutConfigurations.retrieve(id: string): { id: string; affiliate_code: string; company_id: string; currency: currency; metadata: object; mode: checkout_modes; payment_method_configuration: object; plan: object; purchase_url: string; redirect_url: string; }`\n\n**get** `/checkout_configurations/{id}`\n\nRetrieves the details of an existing checkout configuration.\n\nRequired permissions:\n - `checkout_configuration:basic:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; affiliate_code: string; company_id: string; currency: string; metadata: object; mode: 'payment' | 'setup'; payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }; plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; purchase_url: string; redirect_url: string; }`\n  A checkout configuration is a reusable configuration for a checkout, including the plan, affiliate, and custom metadata. Payments and memberships created from a checkout session inherit its metadata.\n\n  - `id: string`\n  - `affiliate_code: string`\n  - `company_id: string`\n  - `currency: string`\n  - `metadata: object`\n  - `mode: 'payment' | 'setup'`\n  - `payment_method_configuration: { disabled: string[]; enabled: string[]; include_platform_defaults: boolean; }`\n  - `plan: { id: string; adaptive_pricing_enabled: boolean; billing_period: number; currency: string; expiration_days: number; initial_price: number; plan_type: 'renewal' | 'one_time'; release_method: 'buy_now' | 'waitlist'; renewal_price: number; three_ds_level: 'mandate_challenge' | 'frictionless'; trial_period_days: number; visibility: 'visible' | 'hidden' | 'archived' | 'quick_link'; }`\n  - `purchase_url: string`\n  - `redirect_url: string`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst checkoutConfiguration = await client.checkoutConfigurations.retrieve('ch_xxxxxxxxxxxxxxx');\n\nconsole.log(checkoutConfiguration);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: 'object',
    markdown:
      "## retrieve\n\n`client.payments.retrieve(id: string): object`\n\n**get** `/payments/{id}`\n\nRetrieves the details of an existing payment.\n\nRequired permissions:\n - `payment:basic:read`\n - `plan:basic:read`\n - `access_pass:basic:read`\n - `member:email:read`\n - `member:basic:read`\n - `member:phone:read`\n - `promo_code:basic:read`\n - `shipment:basic:read`\n - `payment:dispute:read`\n - `payment:resolution_center_case:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; amount_after_fees: number; application_fee: { id: string; amount: number; amount_captured: number; amount_refunded: number; created_at: string; currency: currency; }; auto_refunded: boolean; billing_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; billing_reason: string; card_brand: string; card_exp_month: number; card_exp_year: number; card_last4: string; checkout_configuration_id: string; company: { id: string; route: string; title: string; }; created_at: string; currency: string; customer_phone: string; decline_code: string; dispute_alerted_at: string; disputes: { id: string; amount: number; currency: currency; editable: boolean; needs_response_by: string; notes: string; reason: string; status: dispute_statuses; }[]; failure_message: string; fees: { amount: number; currency: currency; name: string; type: string; }[]; financing_installments_count: number; financing_transactions: { id: string; amount: number; created_at: string; status: string; transaction_type: string; }[]; last_payment_attempt: string; member: { id: string; phone: string; }; membership: { id: string; phone_number: string; status: membership_status; }; metadata: object; needs_tracking: boolean; next_payment_attempt: string; paid_at: string; payment_instrument: { card: object; display_name: string; icons: object; installment_count: number; payment_method_type: string; }; payment_method: { id: string; card: object; created_at: string; payment_method_type: payment_method_types; }; payment_method_type: string; payments_failed: number; plan: { id: string; internal_notes: string; metadata: object; }; product: { id: string; metadata: object; route: string; title: string; }; promo_code: { id: string; amount_off: number; base_currency: currency; code: string; number_of_intervals: number; promo_type: promo_type; }; refundable: boolean; refunded_amount: number; refunded_at: string; refunds: { id: string; amount: number; created_at: string; currency: currency; status: refund_status; }[]; resolutions: { id: string; customer_appealed: boolean; customer_response_actions: resolution_center_case_customer_response[]; due_date: string; issue: resolution_center_case_issue_type; merchant_appealed: boolean; merchant_response_actions: resolution_center_case_merchant_response[]; platform_response_actions: resolution_center_case_platform_response[]; status: resolution_center_case_status; }[]; retryable: boolean; risk_score: number; risk_signals: object; settlement_amount: number; settlement_currency: string; settlement_exchange_rate: number; settlement_time_at: string; shipment: { id: string; carrier: string; status: shipment_status; tracking_number: string; tracking_url: string; }; shipping_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; status: 'draft' | 'open' | 'authorized' | 'paid' | 'pending' | 'uncollectible' | 'unresolved' | 'void'; substatus: string; subtotal: number; tax_amount: number; tax_behavior: 'exclusive' | 'inclusive' | 'unspecified' | 'unable_to_collect'; tax_refunded_amount: number; three_ds_verified: boolean; total: number; updated_at: string; usd_total: number; user: { id: string; email: string; name: string; username: string; }; verification_checks: { address_line1: string; card_holder_name: string; card_security_code: string; zip_code: string; }; voidable: boolean; }`\n  A payment represents a completed or attempted charge. Payments track the amount, status, currency, and payment method used.\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst payment = await client.payments.retrieve('pay_xxxxxxxxxxxxxx');\n\nconsole.log(payment);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response: 'object',
    markdown:
      "## refund\n\n`client.payments.refund(id: string, partial_amount?: number): { id: string; amount_after_fees: number; application_fee: object; auto_refunded: boolean; billing_address: object; billing_reason: billing_reasons; card_brand: card_brands; card_exp_month: number; card_exp_year: number; card_last4: string; checkout_configuration_id: string; company: object; created_at: string; currency: currency; customer_phone: string; decline_code: string; dispute_alerted_at: string; disputes: object[]; failure_message: string; fees: object[]; financing_installments_count: number; financing_transactions: object[]; last_payment_attempt: string; member: object; membership: object; metadata: object; needs_tracking: boolean; next_payment_attempt: string; paid_at: string; payment_instrument: object; payment_method: object; payment_method_type: payment_method_types; payments_failed: number; plan: object; product: object; promo_code: object; refundable: boolean; refunded_amount: number; refunded_at: string; refunds: object[]; resolutions: object[]; retryable: boolean; risk_score: number; risk_signals: object; settlement_amount: number; settlement_currency: currency; settlement_exchange_rate: number; settlement_time_at: string; shipment: object; shipping_address: object; status: receipt_status; substatus: friendly_receipt_status; subtotal: number; tax_amount: number; tax_behavior: receipt_tax_behavior; tax_refunded_amount: number; three_ds_verified: boolean; total: number; updated_at: string; usd_total: number; user: object; verification_checks: object; voidable: boolean; }`\n\n**post** `/payments/{id}/refund`\n\nIssue a full or partial refund for a payment. The refund is processed through the original payment processor and the membership status is updated accordingly.\n\nRequired permissions:\n - `payment:manage`\n - `plan:basic:read`\n - `access_pass:basic:read`\n - `member:email:read`\n - `member:basic:read`\n - `member:phone:read`\n - `promo_code:basic:read`\n - `shipment:basic:read`\n - `payment:dispute:read`\n - `payment:resolution_center_case:read`\n\n### Parameters\n\n- `id: string`\n\n- `partial_amount?: number`\n  The amount to refund. For multi-currency payments, this is in the charge currency (what the buyer paid). For single-currency, this is in the payment currency. If omitted, the full payment amount is refunded.\n\n### Returns\n\n- `{ id: string; amount_after_fees: number; application_fee: { id: string; amount: number; amount_captured: number; amount_refunded: number; created_at: string; currency: string; }; auto_refunded: boolean; billing_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; billing_reason: string; card_brand: string; card_exp_month: number; card_exp_year: number; card_last4: string; checkout_configuration_id: string; company: { id: string; route: string; title: string; }; created_at: string; currency: string; customer_phone: string; decline_code: string; dispute_alerted_at: string; disputes: { id: string; amount: number; currency: string; editable: boolean; needs_response_by: string; notes: string; reason: string; status: string; }[]; failure_message: string; fees: { amount: number; currency: string; name: string; type: string; }[]; financing_installments_count: number; financing_transactions: { id: string; amount: number; created_at: string; status: string; transaction_type: string; }[]; last_payment_attempt: string; member: { id: string; phone: string; }; membership: { id: string; phone_number: string; status: string; }; metadata: object; needs_tracking: boolean; next_payment_attempt: string; paid_at: string; payment_instrument: { card: { brand: string; last4: string; }; display_name: string; icons: { card: object; square: object; }; installment_count: number; payment_method_type: string; }; payment_method: { id: string; card: { brand: card_brands; exp_month: number; exp_year: number; fingerprint: string; last4: string; }; created_at: string; payment_method_type: string; }; payment_method_type: string; payments_failed: number; plan: { id: string; internal_notes: string; metadata: object; }; product: { id: string; metadata: object; route: string; title: string; }; promo_code: { id: string; amount_off: number; base_currency: string; code: string; number_of_intervals: number; promo_type: 'percentage' | 'flat_amount'; }; refundable: boolean; refunded_amount: number; refunded_at: string; refunds: { id: string; amount: number; created_at: string; currency: string; status: 'pending' | 'requires_action' | 'succeeded' | 'failed' | 'canceled'; }[]; resolutions: { id: string; customer_appealed: boolean; customer_response_actions: 'respond' | 'appeal' | 'withdraw'[]; due_date: string; issue: string; merchant_appealed: boolean; merchant_response_actions: 'accept' | 'deny' | 'request_more_info' | 'appeal' | 'respond'[]; platform_response_actions: 'request_buyer_info' | 'request_merchant_info' | 'merchant_wins' | 'merchant_refund'[]; status: string; }[]; retryable: boolean; risk_score: number; risk_signals: object; settlement_amount: number; settlement_currency: string; settlement_exchange_rate: number; settlement_time_at: string; shipment: { id: string; carrier: string; status: string; tracking_number: string; tracking_url: string; }; shipping_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; status: 'draft' | 'open' | 'authorized' | 'paid' | 'pending' | 'uncollectible' | 'unresolved' | 'void'; substatus: string; subtotal: number; tax_amount: number; tax_behavior: 'exclusive' | 'inclusive' | 'unspecified' | 'unable_to_collect'; tax_refunded_amount: number; three_ds_verified: boolean; total: number; updated_at: string; usd_total: number; user: { id: string; email: string; name: string; username: string; }; verification_checks: { address_line1: string; card_holder_name: string; card_security_code: string; zip_code: string; }; voidable: boolean; }`\n  A payment represents a completed or attempted charge. Payments track the amount, status, currency, and payment method used.\n\n  - `id: string`\n  - `amount_after_fees: number`\n  - `application_fee: { id: string; amount: number; amount_captured: number; amount_refunded: number; created_at: string; currency: string; }`\n  - `auto_refunded: boolean`\n  - `billing_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }`\n  - `billing_reason: string`\n  - `card_brand: string`\n  - `card_exp_month: number`\n  - `card_exp_year: number`\n  - `card_last4: string`\n  - `checkout_configuration_id: string`\n  - `company: { id: string; route: string; title: string; }`\n  - `created_at: string`\n  - `currency: string`\n  - `customer_phone: string`\n  - `decline_code: string`\n  - `dispute_alerted_at: string`\n  - `disputes: { id: string; amount: number; currency: string; editable: boolean; needs_response_by: string; notes: string; reason: string; status: string; }[]`\n  - `failure_message: string`\n  - `fees: { amount: number; currency: string; name: string; type: string; }[]`\n  - `financing_installments_count: number`\n  - `financing_transactions: { id: string; amount: number; created_at: string; status: string; transaction_type: string; }[]`\n  - `last_payment_attempt: string`\n  - `member: { id: string; phone: string; }`\n  - `membership: { id: string; phone_number: string; status: string; }`\n  - `metadata: object`\n  - `needs_tracking: boolean`\n  - `next_payment_attempt: string`\n  - `paid_at: string`\n  - `payment_instrument: { card: { brand: string; last4: string; }; display_name: string; icons: { card: { dark: { png_1x: string; png_2x: string; png_4x: string; svg: string; }; light: { png_1x: string; png_2x: string; png_4x: string; svg: string; }; }; square: { dark: { png_1x: string; png_2x: string; png_4x: string; svg: string; }; light: { png_1x: string; png_2x: string; png_4x: string; svg: string; }; }; }; installment_count: number; payment_method_type: string; }`\n  - `payment_method: { id: string; card: { brand: string; exp_month: number; exp_year: number; fingerprint: string; last4: string; }; created_at: string; payment_method_type: string; }`\n  - `payment_method_type: string`\n  - `payments_failed: number`\n  - `plan: { id: string; internal_notes: string; metadata: object; }`\n  - `product: { id: string; metadata: object; route: string; title: string; }`\n  - `promo_code: { id: string; amount_off: number; base_currency: string; code: string; number_of_intervals: number; promo_type: 'percentage' | 'flat_amount'; }`\n  - `refundable: boolean`\n  - `refunded_amount: number`\n  - `refunded_at: string`\n  - `refunds: { id: string; amount: number; created_at: string; currency: string; status: 'pending' | 'requires_action' | 'succeeded' | 'failed' | 'canceled'; }[]`\n  - `resolutions: { id: string; customer_appealed: boolean; customer_response_actions: 'respond' | 'appeal' | 'withdraw'[]; due_date: string; issue: string; merchant_appealed: boolean; merchant_response_actions: 'accept' | 'deny' | 'request_more_info' | 'appeal' | 'respond'[]; platform_response_actions: 'request_buyer_info' | 'request_merchant_info' | 'merchant_wins' | 'merchant_refund'[]; status: string; }[]`\n  - `retryable: boolean`\n  - `risk_score: number`\n  - `risk_signals: object`\n  - `settlement_amount: number`\n  - `settlement_currency: string`\n  - `settlement_exchange_rate: number`\n  - `settlement_time_at: string`\n  - `shipment: { id: string; carrier: string; status: string; tracking_number: string; tracking_url: string; }`\n  - `shipping_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }`\n  - `status: 'draft' | 'open' | 'authorized' | 'paid' | 'pending' | 'uncollectible' | 'unresolved' | 'void'`\n  - `substatus: string`\n  - `subtotal: number`\n  - `tax_amount: number`\n  - `tax_behavior: 'exclusive' | 'inclusive' | 'unspecified' | 'unable_to_collect'`\n  - `tax_refunded_amount: number`\n  - `three_ds_verified: boolean`\n  - `total: number`\n  - `updated_at: string`\n  - `usd_total: number`\n  - `user: { id: string; email: string; name: string; username: string; }`\n  - `verification_checks: { address_line1: string; card_holder_name: string; card_security_code: string; zip_code: string; }`\n  - `voidable: boolean`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst payment = await client.payments.refund('pay_xxxxxxxxxxxxxx');\n\nconsole.log(payment);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      "{ company_id: string; confirmation_token: string; plan: { currency: string; application_fee_amount?: number; billing_period?: number; description?: string; expiration_days?: number; force_create_new_plan?: boolean; initial_price?: number; internal_notes?: string; plan_type?: 'renewal' | 'one_time'; product?: { external_identifier: string; title: string; collect_shipping_address?: boolean; custom_statement_descriptor?: string; description?: string; global_affiliate_percentage?: number; global_affiliate_status?: 'enabled' | 'disabled'; headline?: string; product_tax_code_id?: string; redirect_purchase_url?: string; route?: string; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; product_id?: string; renewal_price?: number; title?: string; trial_period_days?: number; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; capture?: boolean; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; } | { company_id: string; member_id: string; plan: { currency: string; application_fee_amount?: number; billing_period?: number; description?: string; expiration_days?: number; force_create_new_plan?: boolean; initial_price?: number; internal_notes?: string; plan_type?: 'renewal' | 'one_time'; product?: { external_identifier: string; title: string; collect_shipping_address?: boolean; custom_statement_descriptor?: string; description?: string; global_affiliate_percentage?: number; global_affiliate_status?: 'enabled' | 'disabled'; headline?: string; product_tax_code_id?: string; redirect_purchase_url?: string; route?: string; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; product_id?: string; renewal_price?: number; title?: string; trial_period_days?: number; visibility?: 'visible' | 'hidden' | 'archived' | 'quick_link'; }; capture?: boolean; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; } | { company_id: string; confirmation_token: string; plan_id: string; capture?: boolean; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; } | { company_id: string; member_id: string; plan_id: string; capture?: boolean; email?: string; metadata?: object; payment_method_id?: string; promo_code_id?: string; return_url?: string; };",
    ],
    response: 'object',
    perLanguage: {
      typescript: {
      ...
      ruby: {
        method: 'payments.create',
        example:
          'require "whop_sdk"\n\nwhop = WhopSDK::Client.new(api_key: "My API Key")\n\npayment = whop.payments.create(\n  body: {company_id: "biz_xxxxxxxxxxxxxx", confirmation_token: "confirmation_token", plan: {currency: :usd}}\n)\n\nputs(payment)',
      },
      http: {
        example:
  ...
  },
  {
    ...
    response:
      "{ id: string; certificate_after_completion_enabled: boolean; chapters_count: number; completed_lessons_count: number; cover_image: string; created_at: string; description: string; language: string; latest_lesson_created_at: string; lesson_unlock_days: number[]; order: string; require_completing_lessons_in_order: boolean; resume_lesson: { id: string; }; started_at: string; tagline: string; thumbnail: { id: string; content_type: string; filename: string; optimized_url: string; source_url: string; }; title: string; total_duration_seconds: number; total_lessons_count: number; updated_at: string; visibility: 'visible' | 'hidden'; }",
    markdown:
      "## list\n\n`client.courses.list(after?: string, before?: string, company_id?: string, experience_id?: string, first?: number, last?: number): { id: string; certificate_after_completion_enabled: boolean; chapters_count: number; completed_lessons_count: number; cover_image: string; created_at: string; description: string; language: languages; latest_lesson_created_at: string; lesson_unlock_days: number[]; order: string; require_completing_lessons_in_order: boolean; resume_lesson: object; started_at: string; tagline: string; thumbnail: object; title: string; total_duration_seconds: number; total_lessons_count: number; updated_at: string; visibility: course_visibilities; }`\n\n**get** `/courses`\n\nReturns a paginated list of courses, filtered by either an experience or a company.\n\nRequired permissions:\n - `courses:read`\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `company_id?: string`\n  The unique identifier of the company to list courses for.\n\n- `experience_id?: string`\n  The unique identifier of the experience to list courses for.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n### Returns\n\n- `{ id: string; certificate_after_completion_enabled: boolean; chapters_count: number; completed_lessons_count: number; cover_image: string; created_at: string; description: string; language: string; latest_lesson_created_at: string; lesson_unlock_days: number[]; order: string; require_completing_lessons_in_order: boolean; resume_lesson: { id: string; }; started_at: string; tagline: string; thumbnail: { id: string; content_type: string; filename: string; optimized_url: string; source_url: string; }; title: string; total_duration_seconds: number; total_lessons_count: number; updated_at: string; visibility: 'visible' | 'hidden'; }`\n  A structured learning module containing chapters and lessons, belonging to an experience.\n\n  - `id: string`\n  - `certificate_after_completion_enabled: boolean`\n  - `chapters_count: number`\n  - `completed_lessons_count: number`\n  - `cover_image: string`\n  - `created_at: string`\n  - `description: string`\n  - `language: string`\n  - `latest_lesson_created_at: string`\n  - `lesson_unlock_days: number[]`\n  - `order: string`\n  - `require_completing_lessons_in_order: boolean`\n  - `resume_lesson: { id: string; }`\n  - `started_at: string`\n  - `tagline: string`\n  - `thumbnail: { id: string; content_type: string; filename: string; optimized_url: string; source_url: string; }`\n  - `title: string`\n  - `total_duration_seconds: number`\n  - `total_lessons_count: number`\n  - `updated_at: string`\n  - `visibility: 'visible' | 'hidden'`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const courseListResponse of client.courses.list()) {\n  console.log(courseListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['id: string;'],
    response:
      "{ id: string; checkout_configuration: { id: string; }; company: { id: string; }; created_at: string; error_message: string; member: { id: string; user: { id: string; email: string; name: string; username: string; }; }; metadata: object; payment_method: { id: string; card: { brand: card_brands; exp_month: number; exp_year: number; last4: string; }; created_at: string; mailing_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; payment_method_type: string; }; status: 'processing' | 'succeeded' | 'canceled' | 'requires_action'; three_ds_verified: boolean; }",
    markdown:
      "## retrieve\n\n`client.setupIntents.retrieve(id: string): { id: string; checkout_configuration: object; company: object; created_at: string; error_message: string; member: object; metadata: object; payment_method: object; status: setup_intent_status; three_ds_verified: boolean; }`\n\n**get** `/setup_intents/{id}`\n\nRetrieves the details of an existing setup intent.\n\nRequired permissions:\n - `payment:setup_intent:read`\n - `member:basic:read`\n - `member:email:read`\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; checkout_configuration: { id: string; }; company: { id: string; }; created_at: string; error_message: string; member: { id: string; user: { id: string; email: string; name: string; username: string; }; }; metadata: object; payment_method: { id: string; card: { brand: card_brands; exp_month: number; exp_year: number; last4: string; }; created_at: string; mailing_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; payment_method_type: string; }; status: 'processing' | 'succeeded' | 'canceled' | 'requires_action'; three_ds_verified: boolean; }`\n  A setup intent allows a user to save a payment method for future use without making an immediate purchase.\n\n  - `id: string`\n  - `checkout_configuration: { id: string; }`\n  - `company: { id: string; }`\n  - `created_at: string`\n  - `error_message: string`\n  - `member: { id: string; user: { id: string; email: string; name: string; username: string; }; }`\n  - `metadata: object`\n  - `payment_method: { id: string; card: { brand: string; exp_month: number; exp_year: number; last4: string; }; created_at: string; mailing_address: { city: string; country: string; line1: string; line2: string; name: string; postal_code: string; state: string; }; payment_method_type: string; }`\n  - `status: 'processing' | 'succeeded' | 'canceled' | 'requires_action'`\n  - `three_ds_verified: boolean`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst setupIntent = await client.setupIntents.retrieve('sint_xxxxxxxxxxxxx');\n\nconsole.log(setupIntent);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      ...
      'broken?: boolean;',
      'card_brands?: string[];',
      "card_funding_types?: 'credit' | 'debit' | 'prepaid'[];",
      'company_id?: string;',
      'created_after?: string;',
      'created_before?: string;',
      "direction?: 'asc' | 'desc';",
    ...
    response:
      "{ id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'BasePaymentMethod'; } | { id: string; card: object; created_at: string; has_payer_document: boolean; icons: object; payment_method_type: payment_method_types; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'UsBankAccountPaymentMethod'; us_bank_account: object; } | { id: string; cashapp: object; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; icons: object; ideal: object; payment_method_type: payment_method_types; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; sepa_debit: object; typename: 'SepaDebitPaymentMethod'; }",
    markdown:
      "## list\n\n`client.paymentMethods.list(after?: string, before?: string, broken?: boolean, card_brands?: string[], card_funding_types?: 'credit' | 'debit' | 'prepaid'[], company_id?: string, created_after?: string, created_before?: string, direction?: 'asc' | 'desc', expired?: boolean, first?: number, future_usage?: 'off_session' | 'on_session', has_payer_document?: boolean, last?: number, member_id?: string, payment_method_types?: string[]): { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'BasePaymentMethod'; } | { id: string; card: object; created_at: string; has_payer_document: boolean; icons: object; payment_method_type: payment_method_types; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'UsBankAccountPaymentMethod'; us_bank_account: object; } | { id: string; cashapp: object; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; icons: object; ideal: object; payment_method_type: payment_method_types; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; sepa_debit: object; typename: 'SepaDebitPaymentMethod'; }`\n\n**get** `/payment_methods`\n\nReturns a paginated list of payment methods for a member or company, or for the authenticated user when neither is given, with optional filtering by creation date. A payment method is a stored representation of how a customer intends to pay, such as a card, bank account, or digital wallet.\n\nRequired permissions:\n - `member:payment_methods:read`\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `broken?: boolean`\n  Filter by whether the stored credential has permanently stopped charging, such as a vault entry its provider closed.\n\n- `card_brands?: string[]`\n  Only return cards on these networks, such as the networks the seller accepts. Payment methods that are not cards are unaffected.\n\n- `card_funding_types?: 'credit' | 'debit' | 'prepaid'[]`\n  Only return cards funded this way. A card whose funding could not be determined is excluded, and payment methods that are not cards are unaffected.\n\n- `company_id?: string`\n  The unique identifier of the company. Provide either this or member_id, not both. Omit both to address your own saved payment methods.\n\n- `created_after?: string`\n  Only return payment methods created after this timestamp.\n\n- `created_before?: string`\n  Only return payment methods created before this timestamp.\n\n- `direction?: 'asc' | 'desc'`\n  The sort direction for ordering results, either ascending or descending.\n\n- `expired?: boolean`\n  Filter by expiry. Only a card can expire, so `false` keeps every payment method that is not past its expiration month and `true` returns expired cards alone.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `future_usage?: 'off_session' | 'on_session'`\n  Only return methods that can be charged this way after the buyer leaves. Every stored credential answers either usage today, so this narrows nothing — it used to drop the buyer's platform balance, which now lists on its own endpoint instead of here.\n\n- `has_payer_document?: boolean`\n  Filter cards by whether they carry the payer identity document their payment provider requires. Payment methods that are not cards are unaffected.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `member_id?: string`\n  The unique identifier of the member to list payment methods for. Omit this and company_id to list your own saved payment methods.\n\n- `payment_method_types?: string[]`\n  Only return payment methods of these types. Pass the eligible `type` values from the payment method types catalogue so the list holds nothing the purchase cannot take. An empty list returns no payment methods.\n\n### Returns\n\n- `{ id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'BasePaymentMethod'; } | { id: string; card: { brand: string; exp_month: number; exp_year: number; expired: boolean; fingerprint: string; funding_type: 'credit' | 'debit' | 'prepaid'; last4: string; three_ds_verified: boolean; }; created_at: string; has_payer_document: boolean; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'UsBankAccountPaymentMethod'; us_bank_account: { account_type: string; bank_name: string; last4: string; }; } | { id: string; cashapp: { buyer_id: string; cashtag: string; }; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; ideal: { bank: string; bic: string; }; payment_method_type: string; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; sepa_debit: { bank_code: string; branch_code: string; country: string; last4: string; }; typename: 'SepaDebitPaymentMethod'; }`\n  A saved payment method with no type-specific details available.\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const paymentMethodListResponse of client.paymentMethods.list()) {\n  console.log(paymentMethodListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'BasePaymentMethod'; } | { id: string; card: object; created_at: string; has_payer_document: boolean; icons: object; payment_method_type: payment_method_types; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'UsBankAccountPaymentMethod'; us_bank_account: object; } | { id: string; cashapp: object; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; icons: object; ideal: object; payment_method_type: payment_method_types; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; sepa_debit: object; typename: 'SepaDebitPaymentMethod'; }",
    markdown:
      "## retrieve\n\n`client.paymentMethods.retrieve(id: string, company_id?: string, member_id?: string): { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'BasePaymentMethod'; } | { id: string; card: object; created_at: string; has_payer_document: boolean; icons: object; payment_method_type: payment_method_types; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'UsBankAccountPaymentMethod'; us_bank_account: object; } | { id: string; cashapp: object; created_at: string; icons: object; payment_method_type: payment_method_types; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; icons: object; ideal: object; payment_method_type: payment_method_types; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; icons: object; payment_method_type: payment_method_types; sepa_debit: object; typename: 'SepaDebitPaymentMethod'; }`\n\n**get** `/payment_methods/{id}`\n\nRetrieves the details of an existing payment method. Addresses a member's wallet when member_id or company_id is given, otherwise your own.\n\nRequired permissions:\n - `member:payment_methods:read`\n\n### Parameters\n\n- `id: string`\n\n- `company_id?: string`\n  The unique identifier of the company. Provide either this or member_id, not both. Omit both to address your own saved payment methods.\n\n- `member_id?: string`\n  The unique identifier of the member. Provide either this or company_id, not both. Omit both to address your own saved payment methods.\n\n### Returns\n\n- `{ id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'BasePaymentMethod'; } | { id: string; card: { brand: string; exp_month: number; exp_year: number; expired: boolean; fingerprint: string; funding_type: 'credit' | 'debit' | 'prepaid'; last4: string; three_ds_verified: boolean; }; created_at: string; has_payer_document: boolean; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'CardPaymentMethod'; } | { id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'UsBankAccountPaymentMethod'; us_bank_account: { account_type: string; bank_name: string; last4: string; }; } | { id: string; cashapp: { buyer_id: string; cashtag: string; }; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; typename: 'CashappPaymentMethod'; } | { id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; ideal: { bank: string; bic: string; }; payment_method_type: string; typename: 'IdealPaymentMethod'; } | { id: string; created_at: string; icons: { card: { dark: object; light: object; }; square: { dark: object; light: object; }; }; payment_method_type: string; sepa_debit: { bank_code: string; branch_code: string; country: string; last4: string; }; typename: 'SepaDebitPaymentMethod'; }`\n  A saved payment method with no type-specific details available.\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst paymentMethod = await client.paymentMethods.retrieve('payt_xxxxxxxxxxxxx');\n\nconsole.log(paymentMethod);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; created_at: string; currency: string; failure_message: string; paid_at: string; status: 'draft' | 'open' | 'authorized' | 'paid' | 'pending' | 'uncollectible' | 'unresolved' | 'void'; total: number; }",
    markdown:
  ...
  },
  {
    ...
    params: ['id: string;'],
    response:
      "{ id: string; content_type: string; filename: string; size: string; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; url: string; visibility: 'public' | 'private'; }",
    markdown:
      "## retrieve\n\n`client.files.retrieve(id: string): { id: string; content_type: string; filename: string; size: string; upload_status: upload_status; url: string; visibility: file_visibility; }`\n\n**get** `/files/{id}`\n\nRetrieves the details of an existing file.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; content_type: string; filename: string; size: string; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; url: string; visibility: 'public' | 'private'; }`\n  A file that has been uploaded or is pending upload.\n\n  - `id: string`\n  - `content_type: string`\n  - `filename: string`\n  - `size: string`\n  - `upload_status: 'pending' | 'processing' | 'ready' | 'failed'`\n  - `url: string`\n  - `visibility: 'public' | 'private'`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst file = await client.files.retrieve('file_xxxxxxxxxxxxx');\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: ['filename: string;', "visibility?: 'public' | 'private';"],
    response:
      "{ id: string; content_type: string; filename: string; size: string; upload_headers: object; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; upload_url: string; url: string; visibility: 'public' | 'private'; }",
    markdown:
      "## create\n\n`client.files.create(filename: string, visibility?: 'public' | 'private'): { id: string; content_type: string; filename: string; size: string; upload_headers: object; upload_status: upload_status; upload_url: string; url: string; visibility: file_visibility; }`\n\n**post** `/files`\n\nCreate a new file record and receive a presigned URL for uploading content to S3.\n\n### Parameters\n\n- `filename: string`\n  The name of the file including its extension (e.g., \"photo.png\" or \"document.pdf\").\n\n- `visibility?: 'public' | 'private'`\n  Controls whether an uploaded file is publicly accessible or requires authentication to access.\n\n### Returns\n\n- `{ id: string; content_type: string; filename: string; size: string; upload_headers: object; upload_status: 'pending' | 'processing' | 'ready' | 'failed'; upload_url: string; url: string; visibility: 'public' | 'private'; }`\n  A file that has been uploaded or is pending upload.\n\n  - `id: string`\n  - `content_type: string`\n  - `filename: string`\n  - `size: string`\n  - `upload_headers: object`\n  - `upload_status: 'pending' | 'processing' | 'ready' | 'failed'`\n  - `upload_url: string`\n  - `url: string`\n  - `visibility: 'public' | 'private'`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst file = await client.files.create({ filename: 'filename' });\n\nconsole.log(file);\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    response:
      "{ id: string; bounty_type: 'classic' | 'user_funded' | 'workforce'; created_at: string; currency: string; description: string; status: 'published' | 'archived' | 'scheduled'; title: string; total_available: number; total_paid: number; updated_at: string; vote_threshold: number; }",
    markdown:
      "## list\n\n`client.bounties.list(after?: string, before?: string, direction?: 'asc' | 'desc', experience_id?: string, first?: number, last?: number, status?: 'published' | 'archived' | 'scheduled'): { id: string; bounty_type: 'classic' | 'user_funded' | 'workforce'; created_at: string; currency: currency; description: string; status: 'published' | 'archived' | 'scheduled'; title: string; total_available: number; total_paid: number; updated_at: string; vote_threshold: number; }`\n\n**get** `/bounties`\n\nReturns a paginated list of workforce bounties. When experienceId is provided, returns bounties scoped to that experience. When omitted, returns bounties with no experience.\n\n### Parameters\n\n- `after?: string`\n  Returns the elements in the list that come after the specified cursor.\n\n- `before?: string`\n  Returns the elements in the list that come before the specified cursor.\n\n- `direction?: 'asc' | 'desc'`\n  Sort direction. Defaults to descending.\n\n- `experience_id?: string`\n  The experience to list bounties for. When omitted, returns bounties with no experience.\n\n- `first?: number`\n  Returns the first _n_ elements from the list.\n\n- `last?: number`\n  Returns the last _n_ elements from the list.\n\n- `status?: 'published' | 'archived' | 'scheduled'`\n  Filter bounties by status.\n\n### Returns\n\n- `{ id: string; bounty_type: 'classic' | 'user_funded' | 'workforce'; created_at: string; currency: string; description: string; status: 'published' | 'archived' | 'scheduled'; title: string; total_available: number; total_paid: number; updated_at: string; vote_threshold: number; }`\n  A privately accessible bounty.\n\n  - `id: string`\n  - `bounty_type: 'classic' | 'user_funded' | 'workforce'`\n  - `created_at: string`\n  - `currency: string`\n  - `description: string`\n  - `status: 'published' | 'archived' | 'scheduled'`\n  - `title: string`\n  - `total_available: number`\n  - `total_paid: number`\n  - `updated_at: string`\n  - `vote_threshold: number`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\n// Automatically fetches more pages as needed.\nfor await (const bountyListResponse of client.bounties.list()) {\n  console.log(bountyListResponse);\n}\n```",
    perLanguage: {
      typescript: {
  ...
  },
  {
    ...
    params: [
      ...
      'experience_id?: string;',
      'minimum_total_verified_clip_duration_seconds?: number;',
      'origin_account_id?: string;',
      'post_markdown_content?: string;',
      'post_title?: string;',
      "scheduled_frequency?: 'once' | 'hourly' | 'daily' | 'weekly' | 'monthly';",
  ...
  },
  {
    ...
    response:
      "{ id: string; bounty_type: 'classic' | 'user_funded' | 'workforce'; created_at: string; currency: string; description: string; status: 'published' | 'archived' | 'scheduled'; title: string; total_available: number; total_paid: number; updated_at: string; vote_threshold: number; }",
    markdown:
      "## retrieve\n\n`client.bounties.retrieve(id: string): { id: string; bounty_type: 'classic' | 'user_funded' | 'workforce'; created_at: string; currency: currency; description: string; status: 'published' | 'archived' | 'scheduled'; title: string; total_available: number; total_paid: number; updated_at: string; vote_threshold: number; }`\n\n**get** `/bounties/{id}`\n\nRetrieves a workforce bounty for the current authenticated user.\n\n### Parameters\n\n- `id: string`\n\n### Returns\n\n- `{ id: string; bounty_type: 'classic' | 'user_funded' | 'workforce'; created_at: string; currency: string; description: string; status: 'published' | 'archived' | 'scheduled'; title: string; total_available: number; total_paid: number; updated_at: string; vote_threshold: number; }`\n  A privately accessible bounty.\n\n  - `id: string`\n  - `bounty_type: 'classic' | 'user_funded' | 'workforce'`\n  - `created_at: string`\n  - `currency: string`\n  - `description: string`\n  - `status: 'published' | 'archived' | 'scheduled'`\n  - `title: string`\n  - `total_available: number`\n  - `total_paid: number`\n  - `updated_at: string`\n  - `vote_threshold: number`\n\n### Example\n\n```typescript\nimport Whop from '@whop/sdk';\n\nconst client = new Whop();\n\nconst bounty = await client.bounties.retrieve('bnty_xxxxxxxxxxxxx');\n\nconsole.log(bounty);\n```",
    perLanguage: {
      typescript: {
