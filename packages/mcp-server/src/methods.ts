...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.cards.transactions',
    fullyQualifiedName: 'cards.transactions',
    httpMethod: 'get',
    httpPath: '/cards/transactions',
  },
  {
  ...
  {
    clientCallName: 'client.cards.balance',
    fullyQualifiedName: 'cards.balance',
    httpMethod: 'get',
    httpPath: '/cards/{id}/balance',
  },
  {
    clientCallName: 'client.cards.depositAddress',
    fullyQualifiedName: 'cards.depositAddress',
    httpMethod: 'get',
    httpPath: '/cards/{id}/deposit-address',
  },
  {
    clientCallName: 'client.cards.cardTransactions',
    fullyQualifiedName: 'cards.cardTransactions',
    httpMethod: 'get',
    httpPath: '/cards/{id}/transactions',
  },
  {
    clientCallName: 'client.cards.dailySpend',
    fullyQualifiedName: 'cards.dailySpend',
    httpMethod: 'get',
    httpPath: '/cards/{id}/daily-spend',
  },
  {
    clientCallName: 'client.cards.cashback',
    fullyQualifiedName: 'cards.cashback',
    httpMethod: 'get',
    httpPath: '/cards/{id}/cashback',
  },
  {
    clientCallName: 'client.cards.freeze',
    fullyQualifiedName: 'cards.freeze',
    httpMethod: 'post',
    httpPath: '/cards/{id}/freeze',
  },
  {
    clientCallName: 'client.cards.unfreeze',
    fullyQualifiedName: 'cards.unfreeze',
    httpMethod: 'post',
    httpPath: '/cards/{id}/unfreeze',
  },
  {
    clientCallName: 'client.cards.deactivate',
    fullyQualifiedName: 'cards.deactivate',
    httpMethod: 'post',
    httpPath: '/cards/{id}/deactivate',
  },
  {
    clientCallName: 'client.cards.createDispute',
    fullyQualifiedName: 'cards.createDispute',
    httpMethod: 'post',
    httpPath: '/cards/{id}/disputes',
  },
  {
    clientCallName: 'client.cards.createDisputeAttachment',
    fullyQualifiedName: 'cards.createDisputeAttachment',
    httpMethod: 'post',
    httpPath: '/cards/{id}/disputes/{dispute_id}/attachments',
  },
  {
    clientCallName: 'client.cards.secrets',
    fullyQualifiedName: 'cards.secrets',
    httpMethod: 'post',
    httpPath: '/cards/{id}/secrets',
  },
  {
    clientCallName: 'client.cards.pin',
    fullyQualifiedName: 'cards.pin',
    httpMethod: 'get',
    httpPath: '/cards/{id}/pin',
  },
  {
  ...
  {
    clientCallName: 'client.cardAccount.update',
    fullyQualifiedName: 'cardAccount.update',
    httpMethod: 'patch',
    httpPath: '/card-account',
  },
  {
