...
export const sdkMethods: SdkMethod[] = [
  ...
  {
    clientCallName: 'client.referrals.referredUsers',
    fullyQualifiedName: 'referrals.referredUsers',
    httpMethod: 'get',
    httpPath: '/partners/referred_users',
  },
  {
    clientCallName: 'client.referrals.businesses.list',
    fullyQualifiedName: 'referrals.businesses.list',
    httpMethod: 'get',
    httpPath: '/partners/businesses',
  },
  {
    clientCallName: 'client.referrals.businesses.retrieve',
    fullyQualifiedName: 'referrals.businesses.retrieve',
    httpMethod: 'get',
    httpPath: '/partners/businesses/{id}',
  },
  {
    clientCallName: 'client.referrals.businesses.leaderboard',
    fullyQualifiedName: 'referrals.businesses.leaderboard',
    httpMethod: 'get',
    httpPath: '/partners/leaderboard',
  },
  {
    clientCallName: 'client.referrals.businesses.earnings.list',
    fullyQualifiedName: 'referrals.businesses.earnings.list',
    httpMethod: 'get',
    httpPath: '/partners/businesses/{id}/earnings',
  },
  {
    clientCallName: 'client.referrals.partners.create',
    fullyQualifiedName: 'referrals.partners.create',
    httpMethod: 'post',
    httpPath: '/partners',
  },
  {
  ...
  {
    clientCallName: 'client.deposits.list',
    fullyQualifiedName: 'deposits.list',
    httpMethod: 'get',
    httpPath: '/deposits',
  },
  {
  ...
  {
    clientCallName: 'client.workforce.bounties.list',
    fullyQualifiedName: 'workforce.bounties.list',
    httpMethod: 'get',
    httpPath: '/workforce/bounties',
  },
  {
    clientCallName: 'client.workforce.bounties.retrieve',
    fullyQualifiedName: 'workforce.bounties.retrieve',
    httpMethod: 'get',
    httpPath: '/workforce/bounties/{id}',
  },
  {
